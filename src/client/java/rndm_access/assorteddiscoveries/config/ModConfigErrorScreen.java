...
public class ModConfigErrorScreen extends Screen {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float deltaTicks) {
        ...
        context.drawCenteredTextWithShadow(textRenderer,
                Text.literal("The config could not be loaded because of the following error,"),
                width / 2, height / 2 - 80, 0xffffff);
        context.drawCenteredTextWithShadow(textRenderer,
                Text.literal("please fix this error at the specified path before continuing!"),
                width / 2, height / 2 - 65, 0xffffff);
        context.drawCenteredTextWithShadow(textRenderer,
                Text.literal("Assorted Discoveries has fallen back to using all default config options."),
