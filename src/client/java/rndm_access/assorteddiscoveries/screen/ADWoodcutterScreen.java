...
public class ADWoodcutterScreen extends HandledScreen<ADWoodcutterScreenHandler> {
    ...
    protected void drawBackground(DrawContext context, float delta, int mouseX, int mouseY) {
        ...
        context.drawTexture(TEXTURE, xOrigin, yOrigin, 0, 0, this.backgroundWidth, this.backgroundHeight);
        context.drawTexture(TEXTURE, xOrigin + 119, yOrigin + 15 + k, 176 + (this.shouldScroll() ? 0 : 12), 0, 12, 15);
