...
public class AssortedDiscoveries implements ModInitializer {
    ...
    private static void sendConfigToPlayer(ServerPlayer player) {
        BooleanEntriesS2CPayload payload = new BooleanEntriesS2CPayload(ModConfig.getConfig().toEntryList());
    ...
    private static void modifyCreativeTabs() {
        ...
        CreativeModeTabEvents.modifyOutputEvent(MOD_CREATIVE_TAB_KEY).register((entries) -> {
            if (ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_SLIME_PLUSHIE)) {
                entries.accept(ModBlocks.SLIME_PLUSHIE.asItem());
            }

            if (ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_MAGMA_CUBE_PLUSHIE)) {
                entries.accept(ModBlocks.MAGMA_CUBE_PLUSHIE.asItem());
            }

            if (ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_CAT_PLUSHIES)) {
            ...
            if (ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_WOLF_PLUSHIES)) {
            ...
            if (ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_ZOMBIE_PLUSHIE)) {
                entries.accept(ModBlocks.ZOMBIE_PLUSHIE.asItem());
            }

            if (ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_SKELETON_PLUSHIE)) {
                entries.accept(ModBlocks.SKELETON_PLUSHIE.asItem());
            }

            if (ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_ENDERMAN_PLUSHIE)) {
                entries.accept(ModBlocks.ENDERMAN_PLUSHIE.asItem());
            }

            if (ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_CREEPER_PLUSHIE)) {
                entries.accept(ModBlocks.CREEPER_PLUSHIE.asItem());
            }

            if (ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_SPIDER_PLUSHIE)) {
                entries.accept(ModBlocks.SPIDER_PLUSHIE.asItem());
            }

            if (ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_CAVE_SPIDER_PLUSHIE)) {
                entries.accept(ModBlocks.CAVE_SPIDER_PLUSHIE.asItem());
            }

            if (ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_GUARDIAN_PLUSHIE)) {
                entries.accept(ModBlocks.GUARDIAN_PLUSHIE.asItem());
            }

            if (ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_PHANTOM_PLUSHIE)) {
                entries.accept(ModBlocks.PHANTOM_PLUSHIE.asItem());
            }

            if (ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_BAT_PLUSHIE)) {
                entries.accept(ModBlocks.BAT_PLUSHIE.asItem());
            }

            if (ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_SQUID_PLUSHIES)) {
                entries.accept(ModBlocks.SQUID_PLUSHIE.asItem());
                entries.accept(ModBlocks.GLOW_SQUID_PLUSHIE.asItem());
            }

            if (ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_BEE_PLUSHIE)) {
                entries.accept(ModBlocks.BEE_PLUSHIE.asItem());
            }

            if (ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_PIGLIN_PLUSHIES)) {
                entries.accept(ModBlocks.PIGLIN_PLUSHIE.asItem());
                entries.accept(ModBlocks.ZOMBIFIED_PIGLIN_PLUSHIE.asItem());
            }

            if (ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_HOGLIN_PLUSHIES)) {
                entries.accept(ModBlocks.HOGLIN_PLUSHIE.asItem());
                entries.accept(ModBlocks.ZOGLIN_PLUSHIE.asItem());
            }

            if (ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_GHAST_PLUSHIE)) {
                entries.accept(ModBlocks.GHAST_PLUSHIE.asItem());
            }

            if (ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_BLAZE_PLUSHIE)) {
                entries.accept(ModBlocks.BLAZE_PLUSHIE.asItem());
            }

            if (ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_STRIDER_PLUSHIES)) {
                entries.accept(ModBlocks.STRIDER_PLUSHIE.asItem());
                entries.accept(ModBlocks.SHIVERING_STRIDER_PLUSHIE.asItem());
            }

            if (ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_CHICKEN_PLUSHIES)) {
                entries.accept(ModBlocks.TEMPERATE_CHICKEN_PLUSHIE.asItem());
            }

            if (ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_PIG_PLUSHIES)) {
                entries.accept(ModBlocks.TEMPERATE_PIG_PLUSHIE.asItem());
            }

            if (ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_COW_PLUSHIES)) {
                entries.accept(ModBlocks.TEMPERATE_COW_PLUSHIE.asItem());
            }

            if (ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_MOOSHROOM_PLUSHIES)) {
                entries.accept(ModBlocks.RED_MOOSHROOM_PLUSHIE.asItem());
                entries.accept(ModBlocks.BROWN_MOOSHROOM_PLUSHIE.asItem());
            }

            if (ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_SHEEP_PLUSHIES)) {
            ...
            if (ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_HORSE_PLUSHIES)) {
            ...
            if (ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_RABBIT_PLUSHIES)) {
            ...
            if (ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_ILLAGER_PLUSHIES)) {
            ...
            if (ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_VILLAGER_PLUSHIES)) {
            ...
            if (ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_WITCH_PLUSHIE)) {
                entries.accept(ModBlocks.WITCH_PLUSHIE.asItem());
            }

            if (ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_PUFFERFISH_PLUSHIE)) {
                entries.accept(ModBlocks.PUFFERFISH_PLUSHIE.asItem());
            }

            if (ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_WITHER_PLUSHIE)) {
                entries.accept(ModBlocks.WITHER_PLUSHIE.asItem());
            }

            if (ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_ALLAY_PLUSHIE)) {
                entries.accept(ModBlocks.ALLAY_PLUSHIE.asItem());
            }

            if (ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_VEX_PLUSHIE)) {
                entries.accept(ModBlocks.VEX_PLUSHIE.asItem());
            }

            if (ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_SHULKER_PLUSHIE)) {
                entries.accept(ModBlocks.SHULKER_PLUSHIE.asItem());
            }

            if (ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_CAMEL_PLUSHIE)) {
                entries.accept(ModBlocks.CAMEL_PLUSHIE.asItem());
            }

            if (ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_CREAKING_PLUSHIE)) {
                entries.accept(ModBlocks.CREAKING_PLUSHIE.asItem());
            }

            if (ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_SNIFFER_PLUSHIE)) {
                entries.accept(ModBlocks.SNIFFER_PLUSHIE.asItem());
            }

            if (ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_PLANTER_BOXES)) {
            ...
            if (ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_WOODEN_WALLS)) {
            ...
            if (ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_STRIPPED_WOODEN_WALLS)) {
            ...
            if (ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_ROPE_LADDERS)) {
            ...
            if (ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_IRON_LADDERS)) {
                entries.accept(ModBlocks.IRON_LADDER.asItem());
            }

            if (ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_DYED_CAMPFIRES)) {
            ...
            if (ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_DYED_LANTERNS)) {
            ...
            if (ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_DYED_TORCHES)) {
            ...
            if (ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_TWISTED_NETHERRACK)) {
            ...
            if (ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_WEEPING_NETHERRACK)) {
            ...
            if (ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_TWISTED_NETHER_BRICKS)) {
            ...
            if (ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_WEEPING_NETHER_BRICKS)) {
            ...
            if (ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_TWISTED_BLACKSTONE)) {
            ...
            if (ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_WEEPING_BLACKSTONE)) {
            ...
            if (ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_TWISTED_POLISHED_BLACKSTONE_BRICKS)) {
            ...
            if (ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_WEEPING_POLISHED_BLACKSTONE_BRICKS)) {
            ...
            boolean blackstoneTilesEnabled = ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_BLACKSTONE_TILES);
            ...
            if (blackstoneTilesEnabled && ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_TWISTED_BLACKSTONE_TILES)) {
            ...
            if (blackstoneTilesEnabled && ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_WEEPING_BLACKSTONE_TILES)) {
            ...
            boolean smokyQuartzBlocksEnabled = ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_SMOKY_QUARTZ_BLOCKS);
            ...
            if (smokyQuartzBlocksEnabled && ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_SMOKY_QUARTZ_BRICKS)) {
            ...
            if (smokyQuartzBlocksEnabled && ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_SMOOTH_SMOKY_QUARTZ)) {
            ...
            if (ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_QUARTZ_BRICK_BLOCKS)) {
            ...
            if (ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_QUARTZ_TILES)) {
            ...
            if (ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_QUARTZ_WALLS)) {
                entries.accept(ModBlocks.QUARTZ_WALL.asItem());
                entries.accept(ModBlocks.SMOOTH_QUARTZ_WALL.asItem());
            }

            boolean bauxiteEnabled = ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_BAUXITE);
            if (bauxiteEnabled) {
            ...
            boolean bauxiteBricksEnabled = ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_BAUXITE_BRICKS);
            ...
            if (bauxiteEnabled && bauxiteBricksEnabled && ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_CRACKED_BAUXITE_BRICKS)) {
            ...
            if (bauxiteEnabled && bauxiteBricksEnabled && ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_MOSSY_BAUXITE_BRICKS)) {
            ...
            boolean stoneTilesEnabled = ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_STONE_TILES);
            ...
            if (stoneTilesEnabled && ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_CRACKED_STONE_TILES)) {
            ...
            if (ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_MOSSY_STONE_TILES)) {
            ...
            if (ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_CRACKED_STONE_BRICK_BLOCKS)) {
            ...
            if (ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_STONE_WALLS)) {
                entries.accept(ModBlocks.STONE_WALL.asItem());
            }

            if (ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_CALCITE_BLOCKS)) {
            ...
            if (ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_POLISHED_CALCITE)) {
            ...
            boolean calciteBricksEnabled = ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_CALCITE_BRICKS);
            ...
            if (ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_CRACKED_CALCITE_BRICKS) && calciteBricksEnabled) {
            ...
            if (ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_MOSSY_CALCITE_BRICKS) && calciteBricksEnabled) {
            ...
            if (ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_DRIPSTONE_BLOCKS)) {
            ...
            if (ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_POLISHED_DRIPSTONE)) {
            ...
            boolean dripstoneBricksEnabled = ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_DRIPSTONE_BRICKS);
            ...
            if (ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_CRACKED_DRIPSTONE_BRICKS) && dripstoneBricksEnabled) {
            ...
            if (ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_MOSSY_DRIPSTONE_BRICKS) && dripstoneBricksEnabled) {
            ...
            if (ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_SNOW_BRICKS)) {
            ...
            if (ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_PACKED_SNOW)) {
            ...
            if (ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_DIRT_SLABS)) {
            ...
            if (ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_PURPLE_MUSHROOMS)) {
                entries.accept(ModBlocks.PURPLE_MUSHROOM_BLOCK.asItem());
            }

            if (ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_CATTAILS)) {
                entries.accept(ModBlocks.CATTAIL.asItem());
            }

            if (ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_BOG_BLOSSOMS)) {
                entries.accept(ModBlocks.BOG_BLOSSOM.asItem());
            }

            if (ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_ENDER_PLANTS)) {
            ...
            if (ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_BLOOD_KELP)) {
            ...
            if (ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_GREEN_ONIONS)) {
            ...
            boolean caramelAppleEnabled = ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_CARAMEL_APPLE);
            if (caramelAppleEnabled) {
                entries.accept(ModItems.CARAMEL);
            }

            boolean forestsBountyEnabled = ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_FORESTS_BOUNTY);
            if (forestsBountyEnabled) {
                entries.accept(ModItems.SPRUCE_CONE);
            }

            boolean noodleSoupEnabled = ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_NOODLE_SOUP);
            if (noodleSoupEnabled) {
                entries.accept(ModItems.NOODLES);
            }

            boolean witchsCradleEnabled = ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_WITCHS_CRADLES);
            if (witchsCradleEnabled) {
                entries.accept(ModItems.WITCHS_CRADLE_BRANCH);
            }

            boolean blueberriesEnabled = ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_BLUEBERRIES);
            if (blueberriesEnabled) {
                entries.accept(ModItems.BLUEBERRIES);
            }

            boolean cindersnapBerriesEnabled = ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_CINDERSNAP_BERRIES);
            if (cindersnapBerriesEnabled) {
                entries.accept(ModItems.CINDERSNAP_BERRIES);
            }

            boolean frostbiteBerriesEnabled = ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_FROSTBITE_BERRIES);
            if (frostbiteBerriesEnabled) {
                entries.accept(ModItems.FROSTBITE_BERRIES);
            }

            if (ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_FRIED_EGG)) {
            ...
            if (ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_HOGLIN_STEW)) {
            ...
            if (ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_PUDDING)) {
                entries.accept(ModItems.BERRY_PUDDING);
                entries.accept(ModItems.PUDDING);
            }

            if (frostbiteBerriesEnabled && ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_WARPED_FORAGE_MIX)) {
                entries.accept(ModItems.WARPED_FORAGE_MIX);
            }

            if (cindersnapBerriesEnabled && ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_CRIMSON_FORAGE_MIX)) {
                entries.accept(ModItems.CRIMSON_FORAGE_MIX);
            }

            if (blueberriesEnabled && ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_BLUEBERRY_JUICE)) {
                entries.accept(ModItems.BLUEBERRY_JUICE);
            }

            if (ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_SWEET_BERRY_JUICE)) {
                entries.accept(ModItems.SWEET_BERRY_JUICE);
            }

            if (ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_CINDERSNAP_BERRY_JUICE)
                    && cindersnapBerriesEnabled) {
                entries.accept(ModItems.CINDERSNAP_BERRY_JUICE);
            }

            if (ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_FROSTBITE_BERRY_JUICE)
                    && frostbiteBerriesEnabled) {
                entries.accept(ModItems.FROSTBITE_BERRY_JUICE);
            }

            if (blueberriesEnabled && ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_BLUEBERRY_PIE)) {
                entries.accept(ModBlocks.BLUEBERRY_PIE.asItem());
            }

            if (ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_SWEET_BERRY_PIE)) {
                entries.accept(ModBlocks.SWEET_BERRY_PIE.asItem());
            }

            if (ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_CHOCOLATE_CAKE)) {
                entries.accept(ModBlocks.CHOCOLATE_CAKE.asItem());
            }

            if (ModConfig.getConfig().getBooleanValue(ModConfigKeys.ENABLE_RED_VELVET_CAKE)) {
