...
public class AssortedDiscoveries implements ModInitializer {
	...
	private static void addFeaturesToBiomes() {
        if (ModConfig.ENABLE_CATTAILS.getValue().evaluate()) {
        ...
        if (ModConfig.ENABLE_PURPLE_MUSHROOMS.getValue().evaluate()) {
        ...
        if (ModConfig.ENABLE_BLUEBERRIES.getValue().evaluate()) {
        ...
        if (ModConfig.ENABLE_WITCHS_CRADLE_SOUP.getValue().evaluate()) {
        ...
        if (ModConfig.ENABLE_ENDER_PLANTS.getValue().evaluate()) {
        ...
        if (ModConfig.ENABLE_BLOOD_KELP.getValue().evaluate()) {
        ...
        if (ModConfig.ENABLE_BOG_BLOSSOMS.getValue().evaluate()) {
        ...
        if (ModConfig.ENABLE_NETHER_BERRIES.getValue().evaluate()) {
        ...
        if (ModConfig.ENABLE_GREEN_ONIONS.getValue().evaluate()) {
	...
	private static void modifyLootTables() {
        ...
        if(ModConfig.ENABLE_FORESTS_BOUNTY.getValue().evaluate()) {
	...
	private static void addItemGroups() {
		Registry.register(Registries.ITEM_GROUP, ITEM_GROUP_KEY, FabricItemGroup.builder()
				...
				.entries((context, entries) -> {
                    if (ModConfig.ENABLE_SLIME_PLUSHIE.getValue().evaluate()) {
                        entries.add(ModItems.SLIME_PLUSHIE);
                    }

                    if (ModConfig.ENABLE_MAGMA_CUBE_PLUSHIE.getValue().evaluate()) {
                        entries.add(ModItems.MAGMA_CUBE_PLUSHIE);
                    }

                    if (ModConfig.ENABLE_OCELOT_PLUSHIE.getValue().evaluate()) {
                        entries.add(ModItems.OCELOT_PLUSHIE);
                    }

                    if (ModConfig.ENABLE_CAT_PLUSHIES.getValue().evaluate()) {
                    ...
                    if (ModConfig.ENABLE_PALE_WOLF_PLUSHIE.getValue().evaluate()) {
                        entries.add(ModItems.PALE_WOLF_PLUSHIE);
                    }

                    if (ModConfig.ENABLE_ZOMBIE_PLUSHIE.getValue().evaluate()) {
                        entries.add(ModItems.ZOMBIE_PLUSHIE);
                    }

                    if (ModConfig.ENABLE_SKELETON_PLUSHIE.getValue().evaluate()) {
                        entries.add(ModItems.SKELETON_PLUSHIE);
                    }

                    if (ModConfig.ENABLE_ENDERMAN_PLUSHIE.getValue().evaluate()) {
                        entries.add(ModItems.ENDERMAN_PLUSHIE);
                    }

                    if (ModConfig.ENABLE_CREEPER_PLUSHIE.getValue().evaluate()) {
                        entries.add(ModItems.CREEPER_PLUSHIE);
                    }

                    if (ModConfig.ENABLE_SPIDER_PLUSHIE.getValue().evaluate()) {
                        entries.add(ModItems.SPIDER_PLUSHIE);
                    }

                    if (ModConfig.ENABLE_CAVE_SPIDER_PLUSHIE.getValue().evaluate()) {
                        entries.add(ModItems.CAVE_SPIDER_PLUSHIE);
                    }

                    if (ModConfig.ENABLE_GUARDIAN_PLUSHIE.getValue().evaluate()) {
                        entries.add(ModItems.GUARDIAN_PLUSHIE);
                    }

                    if (ModConfig.ENABLE_PHANTOM_PLUSHIE.getValue().evaluate()) {
                        entries.add(ModItems.PHANTOM_PLUSHIE);
                    }

                    if (ModConfig.ENABLE_BAT_PLUSHIE.getValue().evaluate()) {
                        entries.add(ModItems.BAT_PLUSHIE);
                    }

                    if (ModConfig.ENABLE_SQUID_PLUSHIES.getValue().evaluate()) {
                        entries.add(ModItems.SQUID_PLUSHIE);
                        entries.add(ModItems.GLOW_SQUID_PLUSHIE);
                    }

                    if (ModConfig.ENABLE_BEE_PLUSHIE.getValue().evaluate()) {
                        entries.add(ModItems.BEE_PLUSHIE);
                    }

                    if (ModConfig.ENABLE_PIGLIN_PLUSHIES.getValue().evaluate()) {
                        entries.add(ModItems.PIGLIN_PLUSHIE);
                        entries.add(ModItems.ZOMBIFIED_PIGLIN_PLUSHIE);
                    }

                    if (ModConfig.ENABLE_HOGLIN_PLUSHIES.getValue().evaluate()) {
                        entries.add(ModItems.HOGLIN_PLUSHIE);
                        entries.add(ModItems.ZOGLIN_PLUSHIE);
                    }

                    if (ModConfig.ENABLE_GHAST_PLUSHIE.getValue().evaluate()) {
                        entries.add(ModItems.GHAST_PLUSHIE);
                    }

                    if (ModConfig.ENABLE_BLAZE_PLUSHIE.getValue().evaluate()) {
                        entries.add(ModItems.BLAZE_PLUSHIE);
                    }

                    if (ModConfig.ENABLE_STRIDER_PLUSHIES.getValue().evaluate()) {
                        entries.add(ModItems.STRIDER_PLUSHIE);
                        entries.add(ModItems.SHIVERING_STRIDER_PLUSHIE);
                    }

                    if (ModConfig.ENABLE_CHICKEN_PLUSHIE.getValue().evaluate()) {
                        entries.add(ModItems.CHICKEN_PLUSHIE);
                    }

                    if (ModConfig.ENABLE_PIG_PLUSHIE.getValue().evaluate()) {
                        entries.add(ModItems.PIG_PLUSHIE);
                    }

                    if (ModConfig.ENABLE_COW_PLUSHIE.getValue().evaluate()) {
                        entries.add(ModItems.COW_PLUSHIE);
                    }

                    if (ModConfig.ENABLE_MOOSHROOM_PLUSHIES.getValue().evaluate()) {
                        entries.add(ModItems.RED_MOOSHROOM_PLUSHIE);
                        entries.add(ModItems.BROWN_MOOSHROOM_PLUSHIE);
                    }

                    if (ModConfig.ENABLE_SHEEP_PLUSHIES.getValue().evaluate()) {
                    ...
                    if (ModConfig.ENABLE_RABBIT_PLUSHIES.getValue().evaluate()) {
                    ...
                    if (ModConfig.ENABLE_ZOMBIE_VILLAGER_PLUSHIES.getValue().evaluate()) {
                    ...
                    if (ModConfig.ENABLE_WITCH_PLUSHIE.getValue().evaluate()) {
                        entries.add(ModItems.WITCH_PLUSHIE);
                    }

                    if (ModConfig.ENABLE_PUFFERFISH_PLUSHIE.getValue().evaluate()) {
                        entries.add(ModItems.PUFFERFISH_PLUSHIE);
                    }

                    if (ModConfig.ENABLE_WITHER_PLUSHIE.getValue().evaluate()) {
                        entries.add(ModItems.WITHER_PLUSHIE);
                    }

                    if (ModConfig.ENABLE_POLAR_BEAR_PLUSHIE.getValue().evaluate()) {
                        entries.add(ModItems.POLAR_BEAR_PLUSHIE);
                    }

                    if (ModConfig.ENABLE_ALLAY_PLUSHIE.getValue().evaluate()) {
                        entries.add(ModItems.ALLAY_PLUSHIE);
                    }

                    if (ModConfig.ENABLE_VEX_PLUSHIE.getValue().evaluate()) {
                        entries.add(ModItems.VEX_PLUSHIE);
                    }

                    if (ModConfig.ENABLE_RAVAGER_PLUSHIE.getValue().evaluate()) {
                        entries.add(ModItems.RAVAGER_PLUSHIE);
                    }

					if (ModConfig.ENABLE_SHULKER_PLUSHIE.getValue().evaluate()) {
                        entries.add(ModItems.SHULKER_PLUSHIE);
                    }

					if (ModConfig.ENABLE_CAMEL_PLUSHIE.getValue().evaluate()) {
                    ...
                    if (ModConfig.ENABLE_WOODCUTTER.getValue().evaluate()) {
                        entries.add(ModItems.WOODCUTTER);
                    }

                    if (ModConfig.ENABLE_WOODEN_WALLS.getValue().evaluate()) {
                    ...
                    if (ModConfig.ENABLE_STRIPPED_WOODEN_WALLS.getValue().evaluate()) {
                    ...
                    if (ModConfig.ENABLE_WOODEN_ROPE_LADDERS.getValue().evaluate()) {
                    ...
                    if (ModConfig.ENABLE_IRON_LADDERS.getValue().evaluate()) {
                        entries.add(ModItems.IRON_LADDER);
                    }

                    if (ModConfig.ENABLE_DYED_CAMPFIRES.getValue().evaluate()) {
                    ...
                    if (ModConfig.ENABLE_WEEPING_NETHERRACK.getValue().evaluate()) {
                    ...
                    if (ModConfig.ENABLE_TWISTED_NETHER_BRICKS.getValue().evaluate()) {
                    ...
                    if (ModConfig.ENABLE_WEEPING_NETHER_BRICKS.getValue().evaluate()) {
                    ...
                    if (ModConfig.ENABLE_TWISTED_BLACKSTONE.getValue().evaluate()) {
                    ...
                    if (ModConfig.ENABLE_WEEPING_BLACKSTONE.getValue().evaluate()) {
                    ...
                    if (ModConfig.ENABLE_TWISTED_POLISHED_BLACKSTONE_BRICKS.getValue().evaluate()) {
                    ...
                    if (ModConfig.ENABLE_WEEPING_POLISHED_BLACKSTONE_BRICKS.getValue().evaluate()) {
                    ...
                    if (ModConfig.ENABLE_BLACKSTONE_TILES.getValue().evaluate()) {
                    ...
                    if (ModConfig.ENABLE_TWISTED_BLACKSTONE_TILES.getValue().evaluate()) {
                    ...
                    if (ModConfig.ENABLE_WEEPING_BLACKSTONE_TILES.getValue().evaluate()) {
                    ...
                    if (ModConfig.ENABLE_SMOKY_QUARTZ_BLOCKS.getValue().evaluate()) {
                    ...
                    if (ModConfig.ENABLE_SMOKY_QUARTZ_BLOCKS.getValue().evaluate()
                            && ModConfig.ENABLE_SMOKY_QUARTZ_BRICKS.getValue().evaluate()) {
                    ...
                    if (ModConfig.ENABLE_SMOKY_QUARTZ_BLOCKS.getValue().evaluate()
                            && ModConfig.ENABLE_SMOOTH_SMOKY_QUARTZ.getValue().evaluate()) {
                    ...
                    if (ModConfig.ENABLE_QUARTZ_TILES.getValue().evaluate()) {
                    ...
                    if (ModConfig.ENABLE_QUARTZ_WALLS.getValue().evaluate()) {
                        entries.add(ModItems.QUARTZ_WALL);
                        entries.add(ModItems.SMOOTH_QUARTZ_WALL);
                    }

                    if (ModConfig.ENABLE_BAUXITE.getValue().evaluate()) {
                    ...
                    if (ModConfig.ENABLE_BAUXITE_BRICKS.getValue().evaluate()) {
                    ...
                    if (ModConfig.ENABLE_CRACKED_BAUXITE_BRICKS.getValue().evaluate()) {
					...
					if (ModConfig.ENABLE_MOSSY_BAUXITE_BRICKS.getValue().evaluate()) {
                    ...
                    if (ModConfig.ENABLE_STONE_TILES.getValue().evaluate()) {
                    ...
                    if (ModConfig.ENABLE_CRACKED_STONE_TILES.getValue().evaluate()) {
                    ...
                    if (ModConfig.ENABLE_MOSSY_STONE_TILES.getValue().evaluate()) {
                    ...
                    if (ModConfig.ENABLE_CRACKED_STONE_BRICK_BLOCKS.getValue().evaluate()) {
                    ...
                    if (ModConfig.ENABLE_CHOCOLATE_CAKE.getValue().evaluate()) {
                        entries.add(ModItems.CHOCOLATE_CAKE);
                    }

                    if (ModConfig.ENABLE_RED_VELVET_CAKE.getValue().evaluate()) {
                    ...
                    if (ModConfig.ENABLE_BLUEBERRIES.getValue().evaluate()
                            && ModConfig.ENABLE_BLUEBERRY_PIE.getValue().evaluate()) {
                    ...
                    if (ModConfig.ENABLE_NOODLE_SOUP.getValue().evaluate()) {
                    ...
                    if (ModConfig.ENABLE_CARAMEL_APPLE.getValue().evaluate()) {
                        entries.add(ModItems.CARAMEL_APPLE);
                        entries.add(ModItems.CARAMEL);
                    }

                    if (ModConfig.ENABLE_FRIED_EGG.getValue().evaluate()) {
                    ...
                    if (ModConfig.ENABLE_HOGLIN_STEW.getValue().evaluate()) {
                    ...
                    if (ModConfig.ENABLE_PUDDING.getValue().evaluate()) {
                        entries.add(ModItems.BERRY_PUDDING);
                        entries.add(ModItems.PUDDING);
                    }

                    if (ModConfig.ENABLE_BLUEBERRIES.getValue().evaluate()
                            && ModConfig.ENABLE_BLUEBERRY_JUICE.getValue().evaluate()) {
