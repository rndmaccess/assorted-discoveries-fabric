...
public abstract class ADAbstractBerryBushBlock extends PlantBlock implements Fertilizable {
    ...
    @Override
    protected abstract MapCodec<? extends ADAbstractBerryBushBlock> getCodec();
