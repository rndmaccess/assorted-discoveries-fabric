...
public class ADCattailBlock extends TallPlantBlock implements Fertilizable {
    public static final MapCodec<ADCattailBlock> CODEC;
    ...
    @Override
    public MapCodec<ADCattailBlock> getCodec() {
        return CODEC;
    }
    ...
    static {
        CODEC = createCodec(ADCattailBlock::new);
