...
public class ADCubePlushieBlock extends ADAbstractPlushieBlock {
    public static final MapCodec<ADCubePlushieBlock> CODEC;
    ...
    public ADCubePlushieBlock(AbstractBlock.Settings settings) {
        super(settings);
    ...
    @Override
    protected MapCodec<ADCubePlushieBlock> getCodec() {
        return CODEC;
    }
    ...
    static {
        CODEC = createCodec(ADCubePlushieBlock::new);
        ...
        NORTH_TOP_SHAPE = Block.createCuboidShape(5.5D, 0.0D, 5.5D, 10.5D, 4.5D,
                10.5D);
        BOTTOM_SHAPES = ADShapeHelper.makeShapeRotMap(NORTH_BOTTOM_SHAPE);
        MIDDLE_SHAPES = ADShapeHelper.makeShapeRotMap(NORTH_BOTTOM_SHAPE, NORTH_MIDDLE_SHAPE);
        TOP_SHAPES = ADShapeHelper.makeShapeRotMap(NORTH_TOP_SHAPE);
    }
}
