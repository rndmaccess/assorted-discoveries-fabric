...
public class ADPufferfishPlushieBlock extends ADAbstractPlushieBlock {
    public static final MapCodec<ADPufferfishPlushieBlock> CODEC;
    ...
    public ADPufferfishPlushieBlock(AbstractBlock.Settings settings) {
        super(settings);
    ...
    @Override
    protected MapCodec<ADPufferfishPlushieBlock> getCodec() {
        return CODEC;
    }
    ...
    static {
        CODEC = createCodec(ADPufferfishPlushieBlock::new);
        ...
        LARGE_NORTH_SHAPE = Block.createCuboidShape(0.5D, 0.0D, 1.5D, 15.5D, 9.5D,
                12.5D);
        SMALL_SHAPES = ADShapeHelper.makeShapeRotMap(SMALL_NORTH_SHAPE);
        MEDIUM_SHAPES = ADShapeHelper.makeShapeRotMap(MEDIUM_NORTH_SHAPE);
        LARGE_SHAPES = ADShapeHelper.makeShapeRotMap(LARGE_NORTH_SHAPE);
    }
}
