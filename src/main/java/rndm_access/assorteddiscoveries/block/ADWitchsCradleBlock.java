...
public class ADWitchsCradleBlock extends ADAbstractBerryBushBlock {
    public static final MapCodec<ADWitchsCradleBlock> CODEC;
    ...
    @Override
    protected MapCodec<ADWitchsCradleBlock> getCodec() {
        return CODEC;
    }
    ...
    protected TagKey<EntityType<?>> mobsImmune() {
        return CEntityTypeTags.WITCHS_CRADLE_IMMUNE_ENTITY_TYPES;
    }
    ...
    static {
        CODEC = createCodec(ADWitchsCradleBlock::new);
