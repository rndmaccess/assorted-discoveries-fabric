...
public class StriderPlushieBlock extends AbstractSimplePlushieBlock {
    public static final MapCodec<StriderPlushieBlock> CODEC = createCodec(StriderPlushieBlock::new);
    private static final VoxelShape NORTH_SHAPE = Block.createCuboidShape(2.0, 0.0, 3.0,
            14.0, 13.0, 13.0);
