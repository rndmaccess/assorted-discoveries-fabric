...
public class ADConfig {
    ...
    private static ADJsonConfig makeConfig() {
        ...
        ADJsonConfigCategory passivePlushiesSubcategory = new ADJsonConfigCategory.Builder("passive_plushies")
                .addEntry(new ADJsonConfigEntry("enable_allay_plushie", true))
                .addEntry(new ADJsonConfigEntry("enable_bat_plushie", true))
                .addEntry(new ADJsonConfigEntry("enable_camel_plushie", true))
                .addEntry(new ADJsonConfigEntry("enable_cat_plushies", true))
                .addEntry(new ADJsonConfigEntry("enable_chicken_plushie", true))
                .addEntry(new ADJsonConfigEntry("enable_cow_plushie", true))
                .addEntry(new ADJsonConfigEntry("enable_horse_plushies", true))
                .addEntry(new ADJsonConfigEntry("enable_mooshroom_plushies", true))
                .addEntry(new ADJsonConfigEntry("enable_ocelot_plushie", true))
                .addEntry(new ADJsonConfigEntry("enable_pig_plushie", true))
                .addEntry(new ADJsonConfigEntry("enable_pufferfish_plushie", true))
                ...
                .addEntry(new ADJsonConfigEntry("enable_wandering_trader_plushie", true)).build();

        ADJsonConfigCategory neutralPlushiesSubcategory = new ADJsonConfigCategory.Builder("neutral_plushies")
                .addEntry(new ADJsonConfigEntry("enable_bee_plushie", true))
                .addEntry(new ADJsonConfigEntry("enable_cave_spider_plushie", true))
                .addEntry(new ADJsonConfigEntry("enable_enderman_plushie", true))
                .addEntry(new ADJsonConfigEntry("enable_piglin_plushies", true))
                .addEntry(new ADJsonConfigEntry("enable_polar_bear_plushie", true))
                .addEntry(new ADJsonConfigEntry("enable_spider_plushie", true))
                .addEntry(new ADJsonConfigEntry("enable_pale_wolf_plushie", true)).build();

        ADJsonConfigCategory hostilePlushiesSubcategory = new ADJsonConfigCategory.Builder("hostile_plushies")
                .addEntry(new ADJsonConfigEntry("enable_blaze_plushie", true))
                .addEntry(new ADJsonConfigEntry("enable_creeper_plushie", true))
                .addEntry(new ADJsonConfigEntry("enable_ghast_plushie", true))
                .addEntry(new ADJsonConfigEntry("enable_guardian_plushie", true))
                .addEntry(new ADJsonConfigEntry("enable_hoglin_plushies", true))
                .addEntry(new ADJsonConfigEntry("enable_illager_plushies", true))
                .addEntry(new ADJsonConfigEntry("enable_magma_cube_plushie", true))
                .addEntry(new ADJsonConfigEntry("enable_phantom_plushie", true))
                .addEntry(new ADJsonConfigEntry("enable_ravager_plushie", true))
                .addEntry(new ADJsonConfigEntry("enable_shulker_plushie", true))
                .addEntry(new ADJsonConfigEntry("enable_skeleton_plushie", true))
                .addEntry(new ADJsonConfigEntry("enable_slime_plushie", true))
                .addEntry(new ADJsonConfigEntry("enable_vex_plushie", true))
                .addEntry(new ADJsonConfigEntry("enable_witch_plushie", true))
                .addEntry(new ADJsonConfigEntry("enable_wither_plushie", true))
                .addEntry(new ADJsonConfigEntry("enable_zombie_plushie", true))
