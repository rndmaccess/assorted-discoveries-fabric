...
public class ModConfig {
    ...
    private static Config getDefaultConfig() {
        ...
        JsonConfigCategory buildingBlocksCategory = new JsonConfigCategory.Builder("building_blocks")
                ...
                .addComment(new CommentConfigEntry("Toggle all blackstone tile variants (weeping and twisted)"))
                .addEntry(new BooleanConfigEntry(ModConfigKeys.ENABLE_BLACKSTONE_TILES))
                .addComment(new CommentConfigEntry("Toggle twisted blackstone and variants (stairs, slabs, walls)"))
                .addEntry(new BooleanConfigEntry(ModConfigKeys.ENABLE_TWISTED_BLACKSTONE))
                .addComment(new CommentConfigEntry("Toggle twisted blackstone tiles and variants (stairs, slabs, walls)"))
                .addEntry(new BooleanConfigEntry(ModConfigKeys.ENABLE_TWISTED_BLACKSTONE_TILES))
                .addComment(new CommentConfigEntry("Toggle twisted netherrack and variants (stairs, slabs, walls)"))
                .addEntry(new BooleanConfigEntry(ModConfigKeys.ENABLE_TWISTED_NETHERRACK))
                .addComment(new CommentConfigEntry("Toggle twisted nether bricks and variants (stairs, slabs, walls)"))
                .addEntry(new BooleanConfigEntry(ModConfigKeys.ENABLE_TWISTED_NETHER_BRICKS))
                .addComment(new CommentConfigEntry("Toggle twisted polished blackstone bricks and variants (stairs, slabs, walls)"))
                .addEntry(new BooleanConfigEntry(ModConfigKeys.ENABLE_TWISTED_POLISHED_BLACKSTONE_BRICKS))
                .addComment(new CommentConfigEntry("Toggle weeping netherrack and variants (stairs, slabs, walls)"))
                .addEntry(new BooleanConfigEntry(ModConfigKeys.ENABLE_WEEPING_NETHERRACK))
                .addComment(new CommentConfigEntry("Toggle weeping nether bricks and variants (stairs, slabs, walls)"))
                .addEntry(new BooleanConfigEntry(ModConfigKeys.ENABLE_WEEPING_NETHER_BRICKS))
                .addComment(new CommentConfigEntry("Toggle weeping blackstone variants (stairs, slabs, walls)"))
                .addEntry(new BooleanConfigEntry(ModConfigKeys.ENABLE_WEEPING_BLACKSTONE))
                .addComment(new CommentConfigEntry("Toggle weeping polished blackstone bricks and variants (stairs, slabs, walls)"))
                .addEntry(new BooleanConfigEntry(ModConfigKeys.ENABLE_WEEPING_POLISHED_BLACKSTONE_BRICKS))
                .addComment(new CommentConfigEntry("Toggle weeping blackstone tiles and variants (stairs, slabs, walls)"))
                .addEntry(new BooleanConfigEntry(ModConfigKeys.ENABLE_WEEPING_BLACKSTONE_TILES))
                .addComment(new CommentConfigEntry("Toggle all smoky quartz blocks and variants (bricks and smooth)"))
                .addEntry(new BooleanConfigEntry(ModConfigKeys.ENABLE_SMOKY_QUARTZ_BLOCKS))
                .addComment(new CommentConfigEntry("Toggle smoky quartz bricks and variants (stairs, slabs, walls)"))
                ...
                .addComment(new CommentConfigEntry("Toggle the smooth quartz wall and quartz wall"))
                .addEntry(new BooleanConfigEntry(ModConfigKeys.ENABLE_QUARTZ_WALLS))
                .addComment(new CommentConfigEntry("Toggle all bauxite variants (normal, bricks, mossy bricks, etc.)"))
                .addEntry(new BooleanConfigEntry(ModConfigKeys.ENABLE_BAUXITE))
                .addComment(new CommentConfigEntry("Toggle all bauxite brick variants (mossy and cracked)"))
                ...
                .addComment(new CommentConfigEntry("Toggle all stone tile variants (normal, cracked, mossy, etc.)"))
                .addEntry(new BooleanConfigEntry(ModConfigKeys.ENABLE_STONE_TILES))
                .addComment(new CommentConfigEntry("Toggle cracked stone tiles and variants (stairs, slabs, walls)"))
                .addEntry(new BooleanConfigEntry(ModConfigKeys.ENABLE_CRACKED_STONE_TILES))
                .addComment(new CommentConfigEntry("Toggle mossy stone tiles and variants (stairs, slabs, walls)"))
                ...
                .addComment(new CommentConfigEntry("Toggle all calcite bricks variants (cracked and mossy)"))
                .addEntry(new BooleanConfigEntry(ModConfigKeys.ENABLE_CALCITE_BRICKS))
                .addComment(new CommentConfigEntry("Toggle cracked calcite bricks and variants (stairs, slabs, walls)"))
                .addEntry(new BooleanConfigEntry(ModConfigKeys.ENABLE_CRACKED_CALCITE_BRICKS))
                .addComment(new CommentConfigEntry("Toggle mossy calcite bricks and variants (stairs, slabs, walls)"))
                ...
                .addComment(new CommentConfigEntry("Toggle polished dripstone and variants (stairs, slabs, walls)"))
                .addEntry(new BooleanConfigEntry(ModConfigKeys.ENABLE_POLISHED_DRIPSTONE))
                .addComment(new CommentConfigEntry("Toggle all dripstone bricks and variants (cracked and mossy)"))
                .addEntry(new BooleanConfigEntry(ModConfigKeys.ENABLE_DRIPSTONE_BRICKS))
                .addComment(new CommentConfigEntry("Toggle cracked dripstone bricks and variants (stairs, slabs, and walls)"))
                .addEntry(new BooleanConfigEntry(ModConfigKeys.ENABLE_CRACKED_DRIPSTONE_BRICKS))
                .addComment(new CommentConfigEntry("Toggle mossy dripstone bricks and variants (stairs, slabs, and walls)"))
                .addEntry(new BooleanConfigEntry(ModConfigKeys.ENABLE_MOSSY_DRIPSTONE_BRICKS))
                .addComment(new CommentConfigEntry("Toggle snow bricks and variants (stairs, slabs, and walls)"))
                .addEntry(new BooleanConfigEntry(ModConfigKeys.ENABLE_SNOW_BRICKS))
                .addComment(new CommentConfigEntry("Toggle packed snow and variants (stairs, slabs, and walls)"))
