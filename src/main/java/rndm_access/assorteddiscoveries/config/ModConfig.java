...
public class ModConfig {
    ...
    private static Config getDefaultConfig() {
        ...
        JsonConfigCategory buildingBlocksCategory = new JsonConfigCategory.Builder("building_blocks")
                ...
                .addComment(new CommentConfigEntry("Enable/disable twisted blackstone blocks, and its variants."))
                .addEntry(new BooleanConfigEntry(ModConfigKeys.ENABLE_TWISTED_BLACKSTONE))
                .addComment(new CommentConfigEntry("Enable/disable twisted blackstone tile blocks, and its variants."))
                .addEntry(new BooleanConfigEntry(ModConfigKeys.ENABLE_TWISTED_BLACKSTONE_TILES))
                .addComment(new CommentConfigEntry("Enable/disable twisted netherrack blocks, and its variants."))
                .addEntry(new BooleanConfigEntry(ModConfigKeys.ENABLE_TWISTED_NETHERRACK))
                .addComment(new CommentConfigEntry("Enable/disable twisted nether brick blocks, and its variants."))
                .addEntry(new BooleanConfigEntry(ModConfigKeys.ENABLE_TWISTED_NETHER_BRICKS))
                .addComment(new CommentConfigEntry("Enable/disable twisted polished blackstone brick blocks, and its variants."))
                .addEntry(new BooleanConfigEntry(ModConfigKeys.ENABLE_TWISTED_POLISHED_BLACKSTONE_BRICKS))
                .addComment(new CommentConfigEntry("Enable/disable weeping netherrack blocks, and its variants."))
                .addEntry(new BooleanConfigEntry(ModConfigKeys.ENABLE_WEEPING_NETHERRACK))
                .addComment(new CommentConfigEntry("Enable/disable weeping nether brick blocks, and its variants."))
                .addEntry(new BooleanConfigEntry(ModConfigKeys.ENABLE_WEEPING_NETHER_BRICKS))
                .addComment(new CommentConfigEntry("Enable/disable weeping blackstone blocks, and its variants."))
                .addEntry(new BooleanConfigEntry(ModConfigKeys.ENABLE_WEEPING_BLACKSTONE))
                .addComment(new CommentConfigEntry("Enable/disable weeping polished blackstone brick blocks, and its variants."))
                .addEntry(new BooleanConfigEntry(ModConfigKeys.ENABLE_WEEPING_POLISHED_BLACKSTONE_BRICKS))
                .addComment(new CommentConfigEntry("Enable/disable weeping blackstone tiles, and its variants."))
                ...
                .addComment(new CommentConfigEntry("Enable/disable smoky quartz brick blocks, and its variants."))
                .addEntry(new BooleanConfigEntry(ModConfigKeys.ENABLE_SMOKY_QUARTZ_BRICKS))
                .addComment(new CommentConfigEntry("Enable/disable smooth smoky quartz blocks, and its variants."))
                ...
                .addComment(new CommentConfigEntry("Enable/disable quartz tile blocks, and its variants."))
                ...
                .addComment(new CommentConfigEntry("Enable/disable cracked bauxite brick blocks, and its variants."))
                .addEntry(new BooleanConfigEntry(ModConfigKeys.ENABLE_CRACKED_BAUXITE_BRICKS))
                .addComment(new CommentConfigEntry("Enable/disable mossy bauxite brick blocks, and its variants."))
                ...
                .addComment(new CommentConfigEntry("Enable/disable cracked stone tile blocks, and its variants."))
                .addEntry(new BooleanConfigEntry(ModConfigKeys.ENABLE_CRACKED_STONE_TILES))
                .addComment(new CommentConfigEntry("Enable/disable mossy stone tile blocks, and its variants."))
                ...
                .addComment(new CommentConfigEntry("Enable/disable polished calcite blocks, and its variants."))
                ...
                .addComment(new CommentConfigEntry("Enable/disable cracked calcite brick blocks, and its variants."))
                .addEntry(new BooleanConfigEntry(ModConfigKeys.ENABLE_CRACKED_CALCITE_BRICKS))
                .addComment(new CommentConfigEntry("Enable/disable mossy calcite brick blocks, and its variants."))
                ...
                .addComment(new CommentConfigEntry("Enable/disable polished dripstone blocks, and its variants."))
                ...
                .addComment(new CommentConfigEntry("Enable/disable cracked dripstone brick blocks, and its variants."))
                .addEntry(new BooleanConfigEntry(ModConfigKeys.ENABLE_CRACKED_DRIPSTONE_BRICKS))
                .addComment(new CommentConfigEntry("Enable/disable mossy dripstone brick blocks, and its variants"))
                .addEntry(new BooleanConfigEntry(ModConfigKeys.ENABLE_MOSSY_DRIPSTONE_BRICKS))
                .addComment(new CommentConfigEntry("Enable/disable snow brick blocks, and its variants"))
                .addEntry(new BooleanConfigEntry(ModConfigKeys.ENABLE_SNOW_BRICKS))
                .addComment(new CommentConfigEntry("Enable/disable packed snow blocks, and its variants"))
