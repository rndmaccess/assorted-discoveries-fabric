...
public class ModConfig {
    ...
    private static Config getDefaultConfig() {
        ...
        JsonConfigCategory buildingBlocksCategory = new JsonConfigCategory.Builder("building_blocks")
                ...
                .addComment(new CommentConfigEntry("Toggle all blackstone tiles (normal, weeping, twisted) and their stairs, slabs, and walls."))
                .addEntry(new BooleanConfigEntry(ModConfigKeys.ENABLE_BLACKSTONE_TILES))
                .addComment(new CommentConfigEntry("Toggle twisted blackstone blocks, stairs, slabs, and walls."))
                .addEntry(new BooleanConfigEntry(ModConfigKeys.ENABLE_TWISTED_BLACKSTONE))
                .addComment(new CommentConfigEntry("Toggle twisted blackstone tile blocks, stairs, slabs, and walls."))
                .addEntry(new BooleanConfigEntry(ModConfigKeys.ENABLE_TWISTED_BLACKSTONE_TILES))
                .addComment(new CommentConfigEntry("Toggle twisted netherrack blocks, stairs, slabs, and walls."))
                .addEntry(new BooleanConfigEntry(ModConfigKeys.ENABLE_TWISTED_NETHERRACK))
                .addComment(new CommentConfigEntry("Toggle twisted nether brick blocks, stairs, slabs, and walls."))
                .addEntry(new BooleanConfigEntry(ModConfigKeys.ENABLE_TWISTED_NETHER_BRICKS))
                .addComment(new CommentConfigEntry("Toggle twisted polished blackstone brick blocks, stairs, slabs, and walls."))
                .addEntry(new BooleanConfigEntry(ModConfigKeys.ENABLE_TWISTED_POLISHED_BLACKSTONE_BRICKS))
                .addComment(new CommentConfigEntry("Toggle weeping netherrack blocks, stairs, slabs, and walls."))
                .addEntry(new BooleanConfigEntry(ModConfigKeys.ENABLE_WEEPING_NETHERRACK))
                .addComment(new CommentConfigEntry("Toggle weeping nether brick blocks, stairs, slabs, and walls."))
                .addEntry(new BooleanConfigEntry(ModConfigKeys.ENABLE_WEEPING_NETHER_BRICKS))
                .addComment(new CommentConfigEntry("Toggle weeping blackstone blocks, stairs, slabs, and walls."))
                .addEntry(new BooleanConfigEntry(ModConfigKeys.ENABLE_WEEPING_BLACKSTONE))
                .addComment(new CommentConfigEntry("Toggle weeping polished blackstone brick blocks, stairs, slabs, and walls."))
                .addEntry(new BooleanConfigEntry(ModConfigKeys.ENABLE_WEEPING_POLISHED_BLACKSTONE_BRICKS))
                .addComment(new CommentConfigEntry("Toggle weeping blackstone tiles, stairs, slabs, and walls."))
                .addEntry(new BooleanConfigEntry(ModConfigKeys.ENABLE_WEEPING_BLACKSTONE_TILES))
                .addComment(new CommentConfigEntry("Toggle all smoky quartz blocks (normal, bricks, smooth) and their stairs, slabs, and walls."))
                .addEntry(new BooleanConfigEntry(ModConfigKeys.ENABLE_SMOKY_QUARTZ_BLOCKS))
                .addComment(new CommentConfigEntry("Toggle smoky quartz brick blocks, stairs, slabs, and walls."))
                .addEntry(new BooleanConfigEntry(ModConfigKeys.ENABLE_SMOKY_QUARTZ_BRICKS))
                .addComment(new CommentConfigEntry("Toggle smooth smoky quartz blocks, stairs, slabs, and walls."))
                ...
                .addComment(new CommentConfigEntry("Toggle quartz tile blocks, stairs, slabs, and walls."))
                .addEntry(new BooleanConfigEntry(ModConfigKeys.ENABLE_QUARTZ_TILES))
                .addComment(new CommentConfigEntry("Toggle smooth quartz walls and quartz walls."))
                .addEntry(new BooleanConfigEntry(ModConfigKeys.ENABLE_QUARTZ_WALLS))
                .addComment(new CommentConfigEntry("Toggle all bauxite types (normal, bricks, mossy bricks, etc.) and their stairs, slabs, and walls."))
                .addEntry(new BooleanConfigEntry(ModConfigKeys.ENABLE_BAUXITE))
                .addComment(new CommentConfigEntry("Toggle all bauxite bricks (normal, mossy, cracked) and their stairs, slabs, and walls."))
                .addEntry(new BooleanConfigEntry(ModConfigKeys.ENABLE_BAUXITE_BRICKS))
                .addComment(new CommentConfigEntry("Toggle cracked bauxite brick blocks, stairs, slabs, and walls."))
                .addEntry(new BooleanConfigEntry(ModConfigKeys.ENABLE_CRACKED_BAUXITE_BRICKS))
                .addComment(new CommentConfigEntry("Toggle mossy bauxite brick blocks, stairs, slabs, and walls."))
                .addEntry(new BooleanConfigEntry(ModConfigKeys.ENABLE_MOSSY_BAUXITE_BRICKS))
                .addComment(new CommentConfigEntry("Toggle all stone tiles (normal, cracked, mossy, etc.) and their stairs, slabs, and walls."))
                .addEntry(new BooleanConfigEntry(ModConfigKeys.ENABLE_STONE_TILES))
                .addComment(new CommentConfigEntry("Toggle cracked stone tile blocks, stairs, slabs, and walls."))
                .addEntry(new BooleanConfigEntry(ModConfigKeys.ENABLE_CRACKED_STONE_TILES))
                .addComment(new CommentConfigEntry("Toggle mossy stone tile blocks, stairs, slabs, and walls."))
                ...
                .addComment(new CommentConfigEntry("Toggle polished calcite blocks, stairs, slabs, and walls."))
                .addEntry(new BooleanConfigEntry(ModConfigKeys.ENABLE_POLISHED_CALCITE))
                .addComment(new CommentConfigEntry("Toggle all calcite bricks (normal, cracked, mossy) and their stairs, slabs, and walls."))
                .addEntry(new BooleanConfigEntry(ModConfigKeys.ENABLE_CALCITE_BRICKS))
                .addComment(new CommentConfigEntry("Toggle cracked calcite brick blocks, stairs, slabs, and walls."))
                .addEntry(new BooleanConfigEntry(ModConfigKeys.ENABLE_CRACKED_CALCITE_BRICKS))
                .addComment(new CommentConfigEntry("Toggle mossy calcite brick blocks, stairs, slabs, and walls."))
                .addEntry(new BooleanConfigEntry(ModConfigKeys.ENABLE_MOSSY_CALCITE_BRICKS))
                .addComment(new CommentConfigEntry("Toggle dripstone stairs, slabs, and walls."))
                .addEntry(new BooleanConfigEntry(ModConfigKeys.ENABLE_DRIPSTONE_BLOCKS))
                .addComment(new CommentConfigEntry("Toggle polished dripstone blocks, stairs, slabs, and walls."))
                .addEntry(new BooleanConfigEntry(ModConfigKeys.ENABLE_POLISHED_DRIPSTONE))
                .addComment(new CommentConfigEntry("Toggle all dripstone bricks (normal, cracked, mossy) and their stairs, slabs, and walls."))
                .addEntry(new BooleanConfigEntry(ModConfigKeys.ENABLE_DRIPSTONE_BRICKS))
                .addComment(new CommentConfigEntry("Toggle cracked dripstone brick blocks, stairs, slabs, and walls."))
                .addEntry(new BooleanConfigEntry(ModConfigKeys.ENABLE_CRACKED_DRIPSTONE_BRICKS))
                .addComment(new CommentConfigEntry("Toggle mossy dripstone brick blocks, stairs, slabs, and walls."))
                .addEntry(new BooleanConfigEntry(ModConfigKeys.ENABLE_MOSSY_DRIPSTONE_BRICKS))
                .addComment(new CommentConfigEntry("Toggle snow brick blocks, stairs, slabs, and walls."))
                .addEntry(new BooleanConfigEntry(ModConfigKeys.ENABLE_SNOW_BRICKS))
                .addComment(new CommentConfigEntry("Toggle packed snow blocks, stairs, slabs, and walls."))
                .addEntry(new BooleanConfigEntry(ModConfigKeys.ENABLE_PACKED_SNOW))
                .addComment(new CommentConfigEntry("Toggle all dirt slabs (coarse, grass, podzol, etc.)"))
