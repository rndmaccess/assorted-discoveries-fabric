...
public class ModConfig {
    ...
    public static JsonConfig getInternalConfig() {
        ...
        ConfigCategory buildingBlocksCategory = new ConfigCategory.Builder("building_blocks")
                ...
                .addEntry(new BooleanConfigEntry(ModConfigKeys.ENABLE_WOODEN_ROPE_LADDERS))
        ...
        ConfigCategory passivePlushiesCategory = new ConfigCategory.Builder("passive_plushies")
                ...
                .addEntry(new BooleanConfigEntry(ModConfigKeys.ENABLE_CHICKEN_PLUSHIE))
                .addEntry(new BooleanConfigEntry(ModConfigKeys.ENABLE_COW_PLUSHIE))
                ...
                .addEntry(new BooleanConfigEntry(ModConfigKeys.ENABLE_PIG_PLUSHIE))
                ...
                .addEntry(new BooleanConfigEntry(ModConfigKeys.ENABLE_VILLAGER_PLUSHIES)).build();
