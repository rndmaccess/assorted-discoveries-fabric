...
public class ModConfig {
    ...
    private static Config getDefaultConfig() {
        ...
        ConfigCategory buildingBlocksCategory = new ConfigCategory.Builder("building_blocks")
                ...
                .addComment(new CommentConfigEntry("Toggle quartz brick variants (stairs, slabs, walls) on or off."))
                ...
                .addComment(new CommentConfigEntry("Toggle cracked stone brick variants (stairs, slabs, walls) on or off."))
                ...
                .addComment(new CommentConfigEntry("Toggle calcite variants (stairs, slabs, walls) on or off."))
                ...
                .addComment(new CommentConfigEntry("Toggle dripstone variants (stairs, slabs, walls) on or off."))
