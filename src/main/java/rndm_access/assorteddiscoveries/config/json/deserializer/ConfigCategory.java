...
public class ConfigCategory extends ConfigObject {
    ...
    public List<ConfigObject> getJsonObjects() {
        return Stream.concat(subcategories.values().stream(), entries.values().stream()).toList();
    }

    public static class Builder {
        public String name;
        public Map<String, ConfigCategory> subcategories = new LinkedHashMap<>();
        public Map<String, AbstractConfigEntry<?>> entries = new LinkedHashMap<>();
