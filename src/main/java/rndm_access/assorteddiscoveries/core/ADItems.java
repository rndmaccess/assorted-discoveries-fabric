...
public class ADItems {
    ...
    static {
        BAT_PLUSHIE = blockItem(ADBlocks.BAT_PLUSHIE);
        BLAZE_PLUSHIE = blockItem(ADBlocks.BLAZE_PLUSHIE);
        CAVE_SPIDER_PLUSHIE = blockItem(ADBlocks.CAVE_SPIDER_PLUSHIE);
        CHICKEN_PLUSHIE = blockItem(ADBlocks.CHICKEN_PLUSHIE);
        COW_PLUSHIE = blockItem(ADBlocks.COW_PLUSHIE);
        CREEPER_PLUSHIE = blockItem(ADBlocks.CREEPER_PLUSHIE);
        ENDERMAN_PLUSHIE = blockItem(ADBlocks.ENDERMAN_PLUSHIE);
        GHAST_PLUSHIE = blockItem(ADBlocks.GHAST_PLUSHIE);
        GUARDIAN_PLUSHIE = blockItem(ADBlocks.GUARDIAN_PLUSHIE);
        WHITE_HORSE_PLUSHIE = blockItem(ADBlocks.WHITE_HORSE_PLUSHIE);
        GRAY_HORSE_PLUSHIE = blockItem(ADBlocks.GRAY_HORSE_PLUSHIE);
        LIGHT_GRAY_HORSE_PLUSHIE = blockItem(ADBlocks.LIGHT_GRAY_HORSE_PLUSHIE);
        BROWN_HORSE_PLUSHIE = blockItem(ADBlocks.BROWN_HORSE_PLUSHIE);
        BLACK_HORSE_PLUSHIE = blockItem(ADBlocks.BLACK_HORSE_PLUSHIE);
        MAGMA_CUBE_PLUSHIE = blockItem(ADBlocks.MAGMA_CUBE_PLUSHIE);
        RED_MOOSHROOM_PLUSHIE = blockItem(ADBlocks.RED_MOOSHROOM_PLUSHIE);
        BROWN_MOOSHROOM_PLUSHIE = blockItem(ADBlocks.BROWN_MOOSHROOM_PLUSHIE);
        OCELOT_PLUSHIE = blockItem(ADBlocks.OCELOT_PLUSHIE);
        TABBY_CAT_PLUSHIE = blockItem(ADBlocks.TABBY_CAT_PLUSHIE);
        TUXEDO_CAT_PLUSHIE = blockItem(ADBlocks.TUXEDO_CAT_PLUSHIE);
        RED_CAT_PLUSHIE = blockItem(ADBlocks.RED_CAT_PLUSHIE);
        SIAMESE_CAT_PLUSHIE = blockItem(ADBlocks.SIAMESE_CAT_PLUSHIE);
        BRITISH_SHORTHAIR_CAT_PLUSHIE = blockItem(ADBlocks.BRITISH_SHORTHAIR_CAT_PLUSHIE);
        CALICO_CAT_PLUSHIE = blockItem(ADBlocks.CALICO_CAT_PLUSHIE);
        PERSIAN_CAT_PLUSHIE = blockItem(ADBlocks.PERSIAN_CAT_PLUSHIE);
        RAGDOLL_CAT_PLUSHIE = blockItem(ADBlocks.RAGDOLL_CAT_PLUSHIE);
        WHITE_CAT_PLUSHIE = blockItem(ADBlocks.WHITE_CAT_PLUSHIE);
        JELLIE_CAT_PLUSHIE = blockItem(ADBlocks.JELLIE_CAT_PLUSHIE);
        BLACK_CAT_PLUSHIE = blockItem(ADBlocks.BLACK_CAT_PLUSHIE);
        PIG_PLUSHIE = blockItem(ADBlocks.PIG_PLUSHIE);
        BROWN_RABBIT_PLUSHIE = blockItem(ADBlocks.BROWN_RABBIT_PLUSHIE);
        WHITE_RABBIT_PLUSHIE = blockItem(ADBlocks.WHITE_RABBIT_PLUSHIE);
        BLACK_RABBIT_PLUSHIE = blockItem(ADBlocks.BLACK_RABBIT_PLUSHIE);
        WHITE_SPLOTCHED_RABBIT_PLUSHIE = blockItem(ADBlocks.WHITE_SPLOTCHED_RABBIT_PLUSHIE);
        GOLD_RABBIT_PLUSHIE = blockItem(ADBlocks.GOLD_RABBIT_PLUSHIE);
        TOAST_RABBIT_PLUSHIE = blockItem(ADBlocks.TOAST_RABBIT_PLUSHIE);
        SALT_RABBIT_PLUSHIE = blockItem(ADBlocks.SALT_RABBIT_PLUSHIE);
        WHITE_SHEEP_PLUSHIE = blockItem(ADBlocks.WHITE_SHEEP_PLUSHIE);
        ORANGE_SHEEP_PLUSHIE = blockItem(ADBlocks.ORANGE_SHEEP_PLUSHIE);
        MAGENTA_SHEEP_PLUSHIE = blockItem(ADBlocks.MAGENTA_SHEEP_PLUSHIE);
        LIGHT_BLUE_SHEEP_PLUSHIE = blockItem(ADBlocks.LIGHT_BLUE_SHEEP_PLUSHIE);
        YELLOW_SHEEP_PLUSHIE = blockItem(ADBlocks.YELLOW_SHEEP_PLUSHIE);
        LIME_SHEEP_PLUSHIE = blockItem(ADBlocks.LIME_SHEEP_PLUSHIE);
        PINK_SHEEP_PLUSHIE = blockItem(ADBlocks.PINK_SHEEP_PLUSHIE);
        GRAY_SHEEP_PLUSHIE = blockItem(ADBlocks.GRAY_SHEEP_PLUSHIE);
        LIGHT_GRAY_SHEEP_PLUSHIE = blockItem(ADBlocks.LIGHT_GRAY_SHEEP_PLUSHIE);
        CYAN_SHEEP_PLUSHIE = blockItem(ADBlocks.CYAN_SHEEP_PLUSHIE);
        PURPLE_SHEEP_PLUSHIE = blockItem(ADBlocks.PURPLE_SHEEP_PLUSHIE);
        BLUE_SHEEP_PLUSHIE = blockItem(ADBlocks.BLUE_SHEEP_PLUSHIE);
        BROWN_SHEEP_PLUSHIE = blockItem(ADBlocks.BROWN_SHEEP_PLUSHIE);
        GREEN_SHEEP_PLUSHIE = blockItem(ADBlocks.GREEN_SHEEP_PLUSHIE);
        RED_SHEEP_PLUSHIE = blockItem(ADBlocks.RED_SHEEP_PLUSHIE);
        BLACK_SHEEP_PLUSHIE = blockItem(ADBlocks.BLACK_SHEEP_PLUSHIE);
        MAROON_SHEEP_PLUSHIE = blockItem(ADBlocks.MAROON_SHEEP_PLUSHIE);
        SKELETON_PLUSHIE = blockItem(ADBlocks.SKELETON_PLUSHIE);
        SLIME_PLUSHIE = blockItem(ADBlocks.SLIME_PLUSHIE);
        SPIDER_PLUSHIE = blockItem(ADBlocks.SPIDER_PLUSHIE);
        SQUID_PLUSHIE = blockItem(ADBlocks.SQUID_PLUSHIE);
        GLOW_SQUID_PLUSHIE = blockItem(ADBlocks.GLOW_SQUID_PLUSHIE);
        BEE_PLUSHIE = blockItem(ADBlocks.BEE_PLUSHIE);
        PLAINS_VILLAGER_PLUSHIE = blockItem(ADBlocks.PLAINS_VILLAGER_PLUSHIE);
        DESERT_VILLAGER_PLUSHIE = blockItem(ADBlocks.DESERT_VILLAGER_PLUSHIE);
        JUNGLE_VILLAGER_PLUSHIE = blockItem(ADBlocks.JUNGLE_VILLAGER_PLUSHIE);
        SAVANNA_VILLAGER_PLUSHIE = blockItem(ADBlocks.SAVANNA_VILLAGER_PLUSHIE);
        SNOW_VILLAGER_PLUSHIE = blockItem(ADBlocks.SNOW_VILLAGER_PLUSHIE);
        SWAMP_VILLAGER_PLUSHIE = blockItem(ADBlocks.SWAMP_VILLAGER_PLUSHIE);
        TAIGA_VILLAGER_PLUSHIE = blockItem(ADBlocks.TAIGA_VILLAGER_PLUSHIE);
        CRIMSON_VILLAGER_PLUSHIE = blockItem(ADBlocks.CRIMSON_VILLAGER_PLUSHIE);
        WARPED_VILLAGER_PLUSHIE = blockItem(ADBlocks.WARPED_VILLAGER_PLUSHIE);
        WANDERING_TRADER_PLUSHIE = blockItem(ADBlocks.WANDERING_TRADER_PLUSHIE);
        PLAINS_ZOMBIE_VILLAGER_PLUSHIE = blockItem(ADBlocks.PLAINS_ZOMBIE_VILLAGER_PLUSHIE);
        DESERT_ZOMBIE_VILLAGER_PLUSHIE = blockItem(ADBlocks.DESERT_ZOMBIE_VILLAGER_PLUSHIE);
        JUNGLE_ZOMBIE_VILLAGER_PLUSHIE = blockItem(ADBlocks.JUNGLE_ZOMBIE_VILLAGER_PLUSHIE);
        SAVANNA_ZOMBIE_VILLAGER_PLUSHIE = blockItem(ADBlocks.SAVANNA_ZOMBIE_VILLAGER_PLUSHIE);
        SNOW_ZOMBIE_VILLAGER_PLUSHIE = blockItem(ADBlocks.SNOW_ZOMBIE_VILLAGER_PLUSHIE);
        SWAMP_ZOMBIE_VILLAGER_PLUSHIE = blockItem(ADBlocks.SWAMP_ZOMBIE_VILLAGER_PLUSHIE);
        TAIGA_ZOMBIE_VILLAGER_PLUSHIE = blockItem(ADBlocks.TAIGA_ZOMBIE_VILLAGER_PLUSHIE);
        CRIMSON_ZOMBIE_VILLAGER_PLUSHIE = blockItem(ADBlocks.CRIMSON_ZOMBIE_VILLAGER_PLUSHIE);
        WARPED_ZOMBIE_VILLAGER_PLUSHIE = blockItem(ADBlocks.WARPED_ZOMBIE_VILLAGER_PLUSHIE);
        WITCH_PLUSHIE = blockItem(ADBlocks.WITCH_PLUSHIE);
        PALE_WOLF_PLUSHIE = blockItem(ADBlocks.PALE_WOLF_PLUSHIE);
        ZOMBIE_PLUSHIE = blockItem(ADBlocks.ZOMBIE_PLUSHIE);
        PIGLIN_PLUSHIE = blockItem(ADBlocks.PIGLIN_PLUSHIE);
        ZOMBIFIED_PIGLIN_PLUSHIE = blockItem(ADBlocks.ZOMBIFIED_PIGLIN_PLUSHIE);
        PUFFERFISH_PLUSHIE = blockItem(ADBlocks.PUFFERFISH_PLUSHIE);
        WITHER_PLUSHIE = blockItem(ADBlocks.WITHER_PLUSHIE);
        STRIDER_PLUSHIE = blockItem(ADBlocks.STRIDER_PLUSHIE);
        SHIVERING_STRIDER_PLUSHIE = blockItem(ADBlocks.SHIVERING_STRIDER_PLUSHIE);
        PHANTOM_PLUSHIE = blockItem(ADBlocks.PHANTOM_PLUSHIE);
        HOGLIN_PLUSHIE = blockItem(ADBlocks.HOGLIN_PLUSHIE);
        ZOGLIN_PLUSHIE = blockItem(ADBlocks.ZOGLIN_PLUSHIE);
        POLAR_BEAR_PLUSHIE = blockItem(ADBlocks.POLAR_BEAR_PLUSHIE);
        ALLAY_PLUSHIE = blockItem(ADBlocks.ALLAY_PLUSHIE);
        PILLAGER_PLUSHIE = blockItem(ADBlocks.PILLAGER_PLUSHIE);
        VINDICATOR_PLUSHIE = blockItem(ADBlocks.VINDICATOR_PLUSHIE);
        EVOKER_PLUSHIE = blockItem(ADBlocks.EVOKER_PLUSHIE);
        RAVAGER_PLUSHIE = blockItem(ADBlocks.RAVAGER_PLUSHIE);
        SHULKER_PLUSHIE = blockItem(ADBlocks.SHULKER_PLUSHIE);
        VEX_PLUSHIE = blockItem(ADBlocks.VEX_PLUSHIE);
        NETHER_SMOKY_QUARTZ_ORE = blockItem(ADBlocks.NETHER_SMOKY_QUARTZ_ORE);
        SMOKY_QUARTZ_BLOCK = blockItem(ADBlocks.SMOKY_QUARTZ_BLOCK);
        CHISELED_SMOKY_QUARTZ_BLOCK = blockItem(ADBlocks.CHISELED_SMOKY_QUARTZ_BLOCK);
        SMOKY_QUARTZ_BRICKS = blockItem(ADBlocks.SMOKY_QUARTZ_BRICKS);
        SMOKY_QUARTZ_BRICK_STAIRS = blockItem(ADBlocks.SMOKY_QUARTZ_BRICK_STAIRS);
        SMOKY_QUARTZ_BRICK_SLAB = blockItem(ADBlocks.SMOKY_QUARTZ_BRICK_SLAB);
        SMOKY_QUARTZ_BRICK_WALL = blockItem(ADBlocks.SMOKY_QUARTZ_BRICK_WALL);
        SMOKY_QUARTZ_PILLAR = blockItem(ADBlocks.SMOKY_QUARTZ_PILLAR);
        SMOKY_QUARTZ_STAIRS = blockItem(ADBlocks.SMOKY_QUARTZ_STAIRS);
        SMOKY_QUARTZ_SLAB = blockItem(ADBlocks.SMOKY_QUARTZ_SLAB);
        SMOKY_QUARTZ_WALL = blockItem(ADBlocks.SMOKY_QUARTZ_WALL);
        SMOOTH_SMOKY_QUARTZ = blockItem(ADBlocks.SMOOTH_SMOKY_QUARTZ);
        SMOOTH_SMOKY_QUARTZ_STAIRS = blockItem(ADBlocks.SMOOTH_SMOKY_QUARTZ_STAIRS);
        SMOOTH_SMOKY_QUARTZ_SLAB = blockItem(ADBlocks.SMOOTH_SMOKY_QUARTZ_SLAB);
        SMOOTH_SMOKY_QUARTZ_WALL = blockItem(ADBlocks.SMOOTH_SMOKY_QUARTZ_WALL);
        CRACKED_STONE_BRICK_STAIRS = blockItem(ADBlocks.CRACKED_STONE_BRICK_STAIRS);
        CRACKED_STONE_BRICK_SLAB = blockItem(ADBlocks.CRACKED_STONE_BRICK_SLAB);
        CRACKED_STONE_BRICK_WALL = blockItem(ADBlocks.CRACKED_STONE_BRICK_WALL);
        OAK_PLANTER_BOX = blockItem(ADBlocks.OAK_PLANTER_BOX);
        SPRUCE_PLANTER_BOX = blockItem(ADBlocks.SPRUCE_PLANTER_BOX);
        BIRCH_PLANTER_BOX = blockItem(ADBlocks.BIRCH_PLANTER_BOX);
        JUNGLE_PLANTER_BOX = blockItem(ADBlocks.JUNGLE_PLANTER_BOX);
        ACACIA_PLANTER_BOX = blockItem(ADBlocks.ACACIA_PLANTER_BOX);
        DARK_OAK_PLANTER_BOX = blockItem(ADBlocks.DARK_OAK_PLANTER_BOX);
        MANGROVE_PLANTER_BOX = blockItem(ADBlocks.MANGROVE_PLANTER_BOX);
        CHERRY_PLANTER_BOX = blockItem(ADBlocks.CHERRY_PLANTER_BOX);
        CRIMSON_PLANTER_BOX = blockItem(ADBlocks.CRIMSON_PLANTER_BOX);
        WARPED_PLANTER_BOX = blockItem(ADBlocks.WARPED_PLANTER_BOX);
        OAK_WALL = blockItem(ADBlocks.OAK_WALL);
        SPRUCE_WALL = blockItem(ADBlocks.SPRUCE_WALL);
        BIRCH_WALL = blockItem(ADBlocks.BIRCH_WALL);
        JUNGLE_WALL = blockItem(ADBlocks.JUNGLE_WALL);
        ACACIA_WALL = blockItem(ADBlocks.ACACIA_WALL);
        DARK_OAK_WALL = blockItem(ADBlocks.DARK_OAK_WALL);
        MANGROVE_WALL = blockItem(ADBlocks.MANGROVE_WALL);
        CRIMSON_WALL = blockItem(ADBlocks.CRIMSON_WALL);
        WARPED_WALL = blockItem(ADBlocks.WARPED_WALL);
        CHERRY_WALL = blockItem(ADBlocks.CHERRY_WALL);
        STRIPPED_OAK_WALL = blockItem(ADBlocks.STRIPPED_OAK_WALL);
        STRIPPED_SPRUCE_WALL = blockItem(ADBlocks.STRIPPED_SPRUCE_WALL);
        STRIPPED_BIRCH_WALL = blockItem(ADBlocks.STRIPPED_BIRCH_WALL);
        STRIPPED_JUNGLE_WALL = blockItem(ADBlocks.STRIPPED_JUNGLE_WALL);
        STRIPPED_ACACIA_WALL = blockItem(ADBlocks.STRIPPED_ACACIA_WALL);
        STRIPPED_DARK_OAK_WALL = blockItem(ADBlocks.STRIPPED_DARK_OAK_WALL);
        STRIPPED_MANGROVE_WALL = blockItem(ADBlocks.STRIPPED_MANGROVE_WALL);
        STRIPPED_CRIMSON_WALL = blockItem(ADBlocks.STRIPPED_CRIMSON_WALL);
        STRIPPED_WARPED_WALL = blockItem(ADBlocks.STRIPPED_WARPED_WALL);
        STRIPPED_CHERRY_WALL = blockItem(ADBlocks.STRIPPED_CHERRY_WALL);
        OAK_ROPE_LADDER = ropeLadderBlockItem(ADBlocks.OAK_ROPE_LADDER);
        SPRUCE_ROPE_LADDER = ropeLadderBlockItem(ADBlocks.SPRUCE_ROPE_LADDER);
        BIRCH_ROPE_LADDER = ropeLadderBlockItem(ADBlocks.BIRCH_ROPE_LADDER);
        JUNGLE_ROPE_LADDER = ropeLadderBlockItem(ADBlocks.JUNGLE_ROPE_LADDER);
        ACACIA_ROPE_LADDER = ropeLadderBlockItem(ADBlocks.ACACIA_ROPE_LADDER);
        DARK_OAK_ROPE_LADDER = ropeLadderBlockItem(ADBlocks.DARK_OAK_ROPE_LADDER);
        CRIMSON_ROPE_LADDER = ropeLadderBlockItem(ADBlocks.CRIMSON_ROPE_LADDER);
        WARPED_ROPE_LADDER = ropeLadderBlockItem(ADBlocks.WARPED_ROPE_LADDER);
        MANGROVE_ROPE_LADDER = ropeLadderBlockItem(ADBlocks.MANGROVE_ROPE_LADDER);
        CHERRY_ROPE_LADDER = ropeLadderBlockItem(ADBlocks.CHERRY_ROPE_LADDER);
        IRON_LADDER = blockItem(ADBlocks.IRON_LADDER);
        SNOW_BRICKS = blockItem(ADBlocks.SNOW_BRICKS);
        SNOW_BRICK_STAIRS = blockItem(ADBlocks.SNOW_BRICK_STAIRS);
        SNOW_BRICK_SLAB = blockItem(ADBlocks.SNOW_BRICK_SLAB);
        SNOW_BRICK_WALL = blockItem(ADBlocks.SNOW_BRICK_WALL);
        PACKED_SNOW = blockItem(ADBlocks.PACKED_SNOW);
        PACKED_SNOW_STAIRS = blockItem(ADBlocks.PACKED_SNOW_STAIRS);
        PACKED_SNOW_SLAB = blockItem(ADBlocks.PACKED_SNOW_SLAB);
        PACKED_SNOW_WALL = blockItem(ADBlocks.PACKED_SNOW_WALL);
        PURPLE_MUSHROOM = blockItem(ADBlocks.PURPLE_MUSHROOM);
        PURPLE_MUSHROOM_BLOCK = blockItem(ADBlocks.PURPLE_MUSHROOM_BLOCK);
        WOODCUTTER = blockItem(ADBlocks.WOODCUTTER);
        WHITE_CAMPFIRE = blockItem(ADBlocks.WHITE_CAMPFIRE);
        ORANGE_CAMPFIRE = blockItem(ADBlocks.ORANGE_CAMPFIRE);
        MAGENTA_CAMPFIRE = blockItem(ADBlocks.MAGENTA_CAMPFIRE);
        LIGHT_BLUE_CAMPFIRE = blockItem(ADBlocks.LIGHT_BLUE_CAMPFIRE);
        YELLOW_CAMPFIRE = blockItem(ADBlocks.YELLOW_CAMPFIRE);
        LIME_CAMPFIRE = blockItem(ADBlocks.LIME_CAMPFIRE);
        PINK_CAMPFIRE = blockItem(ADBlocks.PINK_CAMPFIRE);
        GRAY_CAMPFIRE = blockItem(ADBlocks.GRAY_CAMPFIRE);
        LIGHT_GRAY_CAMPFIRE = blockItem(ADBlocks.LIGHT_GRAY_CAMPFIRE);
        CYAN_CAMPFIRE = blockItem(ADBlocks.CYAN_CAMPFIRE);
        PURPLE_CAMPFIRE = blockItem(ADBlocks.PURPLE_CAMPFIRE);
        BLUE_CAMPFIRE = blockItem(ADBlocks.BLUE_CAMPFIRE);
        BROWN_CAMPFIRE = blockItem(ADBlocks.BROWN_CAMPFIRE);
        GREEN_CAMPFIRE = blockItem(ADBlocks.GREEN_CAMPFIRE);
        RED_CAMPFIRE = blockItem(ADBlocks.RED_CAMPFIRE);
        BLACK_CAMPFIRE = blockItem(ADBlocks.BLACK_CAMPFIRE);
        MAROON_CAMPFIRE = blockItem(ADBlocks.MAROON_CAMPFIRE);
        WHITE_LANTERN = blockItem(ADBlocks.WHITE_LANTERN);
        ORANGE_LANTERN = blockItem(ADBlocks.ORANGE_LANTERN);
        MAGENTA_LANTERN = blockItem(ADBlocks.MAGENTA_LANTERN);
        LIGHT_BLUE_LANTERN = blockItem(ADBlocks.LIGHT_BLUE_LANTERN);
        YELLOW_LANTERN = blockItem(ADBlocks.YELLOW_LANTERN);
        LIME_LANTERN = blockItem(ADBlocks.LIME_LANTERN);
        PINK_LANTERN = blockItem(ADBlocks.PINK_LANTERN);
        GRAY_LANTERN = blockItem(ADBlocks.GRAY_LANTERN);
        LIGHT_GRAY_LANTERN = blockItem(ADBlocks.LIGHT_GRAY_LANTERN);
        CYAN_LANTERN = blockItem(ADBlocks.CYAN_LANTERN);
        PURPLE_LANTERN = blockItem(ADBlocks.PURPLE_LANTERN);
        BLUE_LANTERN = blockItem(ADBlocks.BLUE_LANTERN);
        BROWN_LANTERN = blockItem(ADBlocks.BROWN_LANTERN);
        GREEN_LANTERN = blockItem(ADBlocks.GREEN_LANTERN);
        RED_LANTERN = blockItem(ADBlocks.RED_LANTERN);
        BLACK_LANTERN = blockItem(ADBlocks.BLACK_LANTERN);
        MAROON_LANTERN = blockItem(ADBlocks.MAROON_LANTERN);
        WHITE_TORCH = wallStandingBlockItem(ADBlocks.WHITE_TORCH, ADBlocks.WHITE_WALL_TORCH);
        ORANGE_TORCH = wallStandingBlockItem(ADBlocks.ORANGE_TORCH, ADBlocks.ORANGE_WALL_TORCH);
        MAGENTA_TORCH = wallStandingBlockItem(ADBlocks.MAGENTA_TORCH, ADBlocks.MAGENTA_WALL_TORCH);
        LIGHT_BLUE_TORCH = wallStandingBlockItem(ADBlocks.LIGHT_BLUE_TORCH, ADBlocks.LIGHT_BLUE_WALL_TORCH);
        YELLOW_TORCH = wallStandingBlockItem(ADBlocks.YELLOW_TORCH, ADBlocks.YELLOW_WALL_TORCH);
        LIME_TORCH = wallStandingBlockItem(ADBlocks.LIME_TORCH, ADBlocks.LIME_WALL_TORCH);
        PINK_TORCH = wallStandingBlockItem(ADBlocks.PINK_TORCH, ADBlocks.PINK_WALL_TORCH);
        GRAY_TORCH = wallStandingBlockItem(ADBlocks.GRAY_TORCH, ADBlocks.GRAY_WALL_TORCH);
        LIGHT_GRAY_TORCH = wallStandingBlockItem(ADBlocks.LIGHT_GRAY_TORCH, ADBlocks.LIGHT_GRAY_WALL_TORCH);
        CYAN_TORCH = wallStandingBlockItem(ADBlocks.CYAN_TORCH, ADBlocks.CYAN_WALL_TORCH);
        PURPLE_TORCH = wallStandingBlockItem(ADBlocks.PURPLE_TORCH, ADBlocks.PURPLE_WALL_TORCH);
        BLUE_TORCH = wallStandingBlockItem(ADBlocks.BLUE_TORCH, ADBlocks.BLUE_WALL_TORCH);
        BROWN_TORCH = wallStandingBlockItem(ADBlocks.BROWN_TORCH, ADBlocks.BROWN_WALL_TORCH);
        GREEN_TORCH = wallStandingBlockItem(ADBlocks.GREEN_TORCH, ADBlocks.GREEN_WALL_TORCH);
        RED_TORCH = wallStandingBlockItem(ADBlocks.RED_TORCH, ADBlocks.RED_WALL_TORCH);
        BLACK_TORCH = wallStandingBlockItem(ADBlocks.BLACK_TORCH, ADBlocks.BLACK_WALL_TORCH);
        MAROON_TORCH = wallStandingBlockItem(ADBlocks.MAROON_TORCH, ADBlocks.MAROON_WALL_TORCH);
        BAUXITE = blockItem(ADBlocks.BAUXITE);
        BAUXITE_SLAB = blockItem(ADBlocks.BAUXITE_SLAB);
        BAUXITE_STAIRS = blockItem(ADBlocks.BAUXITE_STAIRS);
        BAUXITE_WALL = blockItem(ADBlocks.BAUXITE_WALL);
        BAUXITE_BRICKS = blockItem(ADBlocks.BAUXITE_BRICKS);
        BAUXITE_BRICK_STAIRS = blockItem(ADBlocks.BAUXITE_BRICK_STAIRS);
        BAUXITE_BRICK_SLAB = blockItem(ADBlocks.BAUXITE_BRICK_SLAB);
        BAUXITE_BRICK_WALL = blockItem(ADBlocks.BAUXITE_BRICK_WALL);
        MOSSY_BAUXITE_BRICKS = blockItem(ADBlocks.MOSSY_BAUXITE_BRICKS);
        MOSSY_BAUXITE_BRICK_STAIRS = blockItem(ADBlocks.MOSSY_BAUXITE_BRICK_STAIRS);
        MOSSY_BAUXITE_BRICK_SLAB = blockItem(ADBlocks.MOSSY_BAUXITE_BRICK_SLAB);
        MOSSY_BAUXITE_BRICK_WALL = blockItem(ADBlocks.MOSSY_BAUXITE_BRICK_WALL);
        CRACKED_BAUXITE_BRICKS = blockItem(ADBlocks.CRACKED_BAUXITE_BRICKS);
        CRACKED_BAUXITE_BRICK_STAIRS = blockItem(ADBlocks.CRACKED_BAUXITE_BRICK_STAIRS);
        CRACKED_BAUXITE_BRICK_SLAB = blockItem(ADBlocks.CRACKED_BAUXITE_BRICK_SLAB);
        CRACKED_BAUXITE_BRICK_WALL = blockItem(ADBlocks.CRACKED_BAUXITE_BRICK_WALL);
        TWISTED_NETHER_BRICKS = blockItem(ADBlocks.TWISTED_NETHER_BRICKS);
        TWISTED_NETHER_BRICK_STAIRS = blockItem(ADBlocks.TWISTED_NETHER_BRICK_STAIRS);
        TWISTED_NETHER_BRICK_SLAB = blockItem(ADBlocks.TWISTED_NETHER_BRICK_SLAB);
        TWISTED_NETHER_BRICK_WALL = blockItem(ADBlocks.TWISTED_NETHER_BRICK_WALL);
        TWISTED_NETHERRACK = blockItem(ADBlocks.TWISTED_NETHERRACK);
        TWISTED_NETHERRACK_STAIRS = blockItem(ADBlocks.TWISTED_NETHERRACK_STAIRS);
        TWISTED_NETHERRACK_SLAB = blockItem(ADBlocks.TWISTED_NETHERRACK_SLAB);
        TWISTED_NETHERRACK_WALL = blockItem(ADBlocks.TWISTED_NETHERRACK_WALL);
        WEEPING_NETHER_BRICKS = blockItem(ADBlocks.WEEPING_NETHER_BRICKS);
        WEEPING_NETHER_BRICK_STAIRS = blockItem(ADBlocks.WEEPING_NETHER_BRICK_STAIRS);
        WEEPING_NETHER_BRICK_SLAB = blockItem(ADBlocks.WEEPING_NETHER_BRICK_SLAB);
        WEEPING_NETHER_BRICK_WALL = blockItem(ADBlocks.WEEPING_NETHER_BRICK_WALL);
        WEEPING_NETHERRACK = blockItem(ADBlocks.WEEPING_NETHERRACK);
        WEEPING_NETHERRACK_STAIRS = blockItem(ADBlocks.WEEPING_NETHERRACK_STAIRS);
        WEEPING_NETHERRACK_SLAB = blockItem(ADBlocks.WEEPING_NETHERRACK_SLAB);
        WEEPING_NETHERRACK_WALL = blockItem(ADBlocks.WEEPING_NETHERRACK_WALL);
        SNAPDRAGON = blockItem(ADBlocks.SNAPDRAGON);
        SHORT_ENDER_GRASS = blockItem(ADBlocks.SHORT_ENDER_GRASS);
        CHOCOLATE_CAKE = blockItem(ADBlocks.CHOCOLATE_CAKE);
        RED_VELVET_CAKE = blockItem(ADBlocks.RED_VELVET_CAKE);
        STONE_TILES = blockItem(ADBlocks.STONE_TILES);
        STONE_TILE_SLAB = blockItem(ADBlocks.STONE_TILE_SLAB);
        STONE_TILE_STAIRS = blockItem(ADBlocks.STONE_TILE_STAIRS);
        STONE_TILE_WALL = blockItem(ADBlocks.STONE_TILE_WALL);
        MOSSY_STONE_TILES = blockItem(ADBlocks.MOSSY_STONE_TILES);
        MOSSY_STONE_TILE_SLAB = blockItem(ADBlocks.MOSSY_STONE_TILE_SLAB);
        MOSSY_STONE_TILE_STAIRS = blockItem(ADBlocks.MOSSY_STONE_TILE_STAIRS);
        MOSSY_STONE_TILE_WALL = blockItem(ADBlocks.MOSSY_STONE_TILE_WALL);
        CRACKED_STONE_TILES = blockItem(ADBlocks.CRACKED_STONE_TILES);
        CRACKED_STONE_TILE_SLAB = blockItem(ADBlocks.CRACKED_STONE_TILE_SLAB);
        CRACKED_STONE_TILE_STAIRS = blockItem(ADBlocks.CRACKED_STONE_TILE_STAIRS);
        CRACKED_STONE_TILE_WALL = blockItem(ADBlocks.CRACKED_STONE_TILE_WALL);
        SWEET_BERRY_PIE = blockItem(ADBlocks.SWEET_BERRY_PIE);
        BLUEBERRY_PIE = blockItem(ADBlocks.BLUEBERRY_PIE);
        BLACKSTONE_TILES = blockItem(ADBlocks.BLACKSTONE_TILES);
        BLACKSTONE_TILE_STAIRS = blockItem(ADBlocks.BLACKSTONE_TILE_STAIRS);
        BLACKSTONE_TILE_SLAB = blockItem(ADBlocks.BLACKSTONE_TILE_SLAB);
        BLACKSTONE_TILE_WALL = blockItem(ADBlocks.BLACKSTONE_TILE_WALL);
        TWISTED_BLACKSTONE_TILES = blockItem(ADBlocks.TWISTED_BLACKSTONE_TILES);
        TWISTED_BLACKSTONE_TILE_STAIRS = blockItem(ADBlocks.TWISTED_BLACKSTONE_TILE_STAIRS);
        TWISTED_BLACKSTONE_TILE_SLAB = blockItem(ADBlocks.TWISTED_BLACKSTONE_TILE_SLAB);
        TWISTED_BLACKSTONE_TILE_WALL = blockItem(ADBlocks.TWISTED_BLACKSTONE_TILE_WALL);
        WEEPING_BLACKSTONE_TILES = blockItem(ADBlocks.WEEPING_BLACKSTONE_TILES);
        WEEPING_BLACKSTONE_TILE_STAIRS = blockItem(ADBlocks.WEEPING_BLACKSTONE_TILE_STAIRS);
        WEEPING_BLACKSTONE_TILE_SLAB = blockItem(ADBlocks.WEEPING_BLACKSTONE_TILE_SLAB);
        WEEPING_BLACKSTONE_TILE_WALL = blockItem(ADBlocks.WEEPING_BLACKSTONE_TILE_WALL);
        TWISTED_POLISHED_BLACKSTONE_BRICKS = blockItem(ADBlocks.TWISTED_POLISHED_BLACKSTONE_BRICKS);
        TWISTED_POLISHED_BLACKSTONE_BRICK_STAIRS = blockItem(ADBlocks.TWISTED_POLISHED_BLACKSTONE_BRICK_STAIRS);
        TWISTED_POLISHED_BLACKSTONE_BRICK_SLAB = blockItem(ADBlocks.TWISTED_POLISHED_BLACKSTONE_BRICK_SLAB);
        TWISTED_POLISHED_BLACKSTONE_BRICK_WALL = blockItem(ADBlocks.TWISTED_POLISHED_BLACKSTONE_BRICK_WALL);
        WEEPING_POLISHED_BLACKSTONE_BRICKS = blockItem(ADBlocks.WEEPING_POLISHED_BLACKSTONE_BRICKS);
        WEEPING_POLISHED_BLACKSTONE_BRICK_STAIRS = blockItem(ADBlocks.WEEPING_POLISHED_BLACKSTONE_BRICK_STAIRS);
        WEEPING_POLISHED_BLACKSTONE_BRICK_SLAB = blockItem(ADBlocks.WEEPING_POLISHED_BLACKSTONE_BRICK_SLAB);
        WEEPING_POLISHED_BLACKSTONE_BRICK_WALL = blockItem(ADBlocks.WEEPING_POLISHED_BLACKSTONE_BRICK_WALL);
        TWISTED_BLACKSTONE = blockItem(ADBlocks.TWISTED_BLACKSTONE);
        TWISTED_BLACKSTONE_STAIRS = blockItem(ADBlocks.TWISTED_BLACKSTONE_STAIRS);
        TWISTED_BLACKSTONE_SLAB = blockItem(ADBlocks.TWISTED_BLACKSTONE_SLAB);
        TWISTED_BLACKSTONE_WALL = blockItem(ADBlocks.TWISTED_BLACKSTONE_WALL);
        WEEPING_BLACKSTONE = blockItem(ADBlocks.WEEPING_BLACKSTONE);
        WEEPING_BLACKSTONE_STAIRS = blockItem(ADBlocks.WEEPING_BLACKSTONE_STAIRS);
        WEEPING_BLACKSTONE_SLAB = blockItem(ADBlocks.WEEPING_BLACKSTONE_SLAB);
        WEEPING_BLACKSTONE_WALL = blockItem(ADBlocks.WEEPING_BLACKSTONE_WALL);
        QUARTZ_TILES = blockItem(ADBlocks.QUARTZ_TILES);
        QUARTZ_TILE_STAIRS = blockItem(ADBlocks.QUARTZ_TILE_STAIRS);
        QUARTZ_TILE_SLAB = blockItem(ADBlocks.QUARTZ_TILE_SLAB);
        QUARTZ_TILE_WALL = blockItem(ADBlocks.QUARTZ_TILE_WALL);
        CALCITE_BRICKS = blockItem(ADBlocks.CALCITE_BRICKS);
        CALCITE_BRICK_STAIRS = blockItem(ADBlocks.CALCITE_BRICK_STAIRS);
        CALCITE_BRICK_SLAB = blockItem(ADBlocks.CALCITE_BRICK_SLAB);
        CALCITE_BRICK_WALL = blockItem(ADBlocks.CALCITE_BRICK_WALL);
        MOSSY_CALCITE_BRICKS = blockItem(ADBlocks.MOSSY_CALCITE_BRICKS);
        MOSSY_CALCITE_BRICK_STAIRS = blockItem(ADBlocks.MOSSY_CALCITE_BRICK_STAIRS);
        MOSSY_CALCITE_BRICK_SLAB = blockItem(ADBlocks.MOSSY_CALCITE_BRICK_SLAB);
        MOSSY_CALCITE_BRICK_WALL = blockItem(ADBlocks.MOSSY_CALCITE_BRICK_WALL);
        CRACKED_CALCITE_BRICKS = blockItem(ADBlocks.CRACKED_CALCITE_BRICKS);
        CRACKED_CALCITE_BRICK_STAIRS = blockItem(ADBlocks.CRACKED_CALCITE_BRICK_STAIRS);
        CRACKED_CALCITE_BRICK_SLAB = blockItem(ADBlocks.CRACKED_CALCITE_BRICK_SLAB);
        CRACKED_CALCITE_BRICK_WALL = blockItem(ADBlocks.CRACKED_CALCITE_BRICK_WALL);
        CHISELED_CALCITE_BRICKS = blockItem(ADBlocks.CHISELED_CALCITE_BRICKS);
        DRIPSTONE_BRICKS = blockItem(ADBlocks.DRIPSTONE_BRICKS);
        DRIPSTONE_BRICK_STAIRS = blockItem(ADBlocks.DRIPSTONE_BRICK_STAIRS);
        DRIPSTONE_BRICK_SLAB = blockItem(ADBlocks.DRIPSTONE_BRICK_SLAB);
        DRIPSTONE_BRICK_WALL = blockItem(ADBlocks.DRIPSTONE_BRICK_WALL);
        MOSSY_DRIPSTONE_BRICKS = blockItem(ADBlocks.MOSSY_DRIPSTONE_BRICKS);
        MOSSY_DRIPSTONE_BRICK_STAIRS = blockItem(ADBlocks.MOSSY_DRIPSTONE_BRICK_STAIRS);
        MOSSY_DRIPSTONE_BRICK_SLAB = blockItem(ADBlocks.MOSSY_DRIPSTONE_BRICK_SLAB);
        MOSSY_DRIPSTONE_BRICK_WALL = blockItem(ADBlocks.MOSSY_DRIPSTONE_BRICK_WALL);
        CRACKED_DRIPSTONE_BRICKS = blockItem(ADBlocks.CRACKED_DRIPSTONE_BRICKS);
        CRACKED_DRIPSTONE_BRICK_STAIRS = blockItem(ADBlocks.CRACKED_DRIPSTONE_BRICK_STAIRS);
        CRACKED_DRIPSTONE_BRICK_SLAB = blockItem(ADBlocks.CRACKED_DRIPSTONE_BRICK_SLAB);
        CRACKED_DRIPSTONE_BRICK_WALL = blockItem(ADBlocks.CRACKED_DRIPSTONE_BRICK_WALL);
        CHISELED_DRIPSTONE_BRICKS = blockItem(ADBlocks.CHISELED_DRIPSTONE_BRICKS);
        GREEN_ONION_SEEDS = new AliasedBlockItem(ADBlocks.GREEN_ONIONS, new Item.Settings());
        GREEN_ONION = new Item(new Item.Settings().food(ADFoodComponents.GREEN_ONION));
        BLUEBERRIES = new AliasedBlockItem(ADBlocks.BLUEBERRY_BUSH, new Item.Settings()
                .food(ADFoodComponents.BLUEBERRIES));
        SWEET_BERRY_JUICE = new ADDrinkContainerItem(new Item.Settings()
                .food(ADFoodComponents.SWEET_BERRY_JUICE).maxCount(16));
        BLUEBERRY_JUICE = new ADDrinkContainerItem(new Item.Settings()
                .food(ADFoodComponents.BLUEBERRY_JUICE).maxCount(16));
        NOODLES = new Item(new Item.Settings());
        NOODLE_SOUP = new ADFoodContainerItem(new Item.Settings()
                .food(ADFoodComponents.NOODLE_SOUP).maxCount(1));
        PUDDING = new ADFoodContainerItem(new Item.Settings()
                .food(ADFoodComponents.PUDDING).maxCount(1));
        BERRY_PUDDING = new ADFoodContainerItem(new Item.Settings()
                .food(ADFoodComponents.BERRY_PUDDING).maxCount(1));
        SMOKY_QUARTZ = new Item(new Item.Settings());
        CARAMEL_APPLE = new ADFoodContainerItem(new Item.Settings()
                .food(ADFoodComponents.CARAMEL_APPLE).maxCount(1), Items.STICK);
        CARAMEL = new Item(new Item.Settings().food(ADFoodComponents.CARAMEL));
        SPRUCE_CONE = new Item(new Item.Settings().food(ADFoodComponents.SPRUCE_CONE));
        FORESTS_BOUNTY = new ADFoodContainerItem(new Item.Settings()
                .food(ADFoodComponents.FORESTS_BOUNTY).maxCount(1));
        WITCHS_CRADLE_BRANCH = new AliasedBlockItem(ADBlocks.WITCHS_CRADLE, new Item.Settings()
                .food(ADFoodComponents.WITCHS_CRADLE_BRANCH));
        WITCHS_CRADLE_SOUP = new ADFoodContainerItem(new Item.Settings()
                .food(ADFoodComponents.WITCHS_CRADLE_SOUP).maxCount(1));
        CATTAIL = new AliasedBlockItem(ADBlocks.CATTAIL, new Item.Settings());
        FRIED_EGG = new Item(new Item.Settings().food(ADFoodComponents.FRIED_EGG).maxCount(16));
        BLOOD_KELP_SEED_CLUSTER = new AliasedBlockItem(ADBlocks.BLOOD_KELP, new Item.Settings());
        BLOOD_KELP = new Item(new Item.Settings());
        DRIED_BLOOD_KELP_BLOCK = blockItem(ADBlocks.DRIED_BLOOD_KELP_BLOCK);
        DRIED_BLOOD_KELP = new Item(new Item.Settings().food(FoodComponents.DRIED_KELP));
        BLOOD_KELP_LANTERN = blockItem(ADBlocks.BLOOD_KELP_LANTERN);
        MAROON_WOOL = blockItem(ADBlocks.MAROON_WOOL);
        MAROON_STAINED_GLASS = blockItem(ADBlocks.MAROON_STAINED_GLASS);
        MAROON_STAINED_GLASS_PANE = blockItem(ADBlocks.MAROON_STAINED_GLASS_PANE);
        MAROON_CANDLE = blockItem(ADBlocks.MAROON_CANDLE);
        MAROON_CONCRETE = blockItem(ADBlocks.MAROON_CONCRETE);
        MAROON_CONCRETE_POWDER = blockItem(ADBlocks.MAROON_CONCRETE_POWDER);
        CAMEL_PLUSHIE = blockItem(ADBlocks.CAMEL_PLUSHIE);
        MAROON_DYE = new Item(new Item.Settings());
        HOGLIN_STEW = new ADFoodContainerItem(new Item.Settings()
                .food(ADFoodComponents.HOGLIN_STEW).maxCount(1));
        BOG_BLOSSOM = blockItem(ADBlocks.BOG_BLOSSOM);
        CINDERSNAP_BERRIES = new AliasedBlockItem(ADBlocks.CINDERSNAP_BERRY_BUSH, new Item.Settings()
                .food(ADFoodComponents.NETHER_BERRIES));
        FROSTBITE_BERRIES = new AliasedBlockItem(ADBlocks.FROSTBITE_BERRY_BUSH, new Item.Settings()
                .food(ADFoodComponents.NETHER_BERRIES));
        POLISHED_DRIPSTONE = blockItem(ADBlocks.POLISHED_DRIPSTONE);
        POLISHED_DRIPSTONE_STAIRS = blockItem(ADBlocks.POLISHED_DRIPSTONE_STAIRS);
        POLISHED_DRIPSTONE_SLAB = blockItem(ADBlocks.POLISHED_DRIPSTONE_SLAB);
        POLISHED_DRIPSTONE_WALL = blockItem(ADBlocks.POLISHED_DRIPSTONE_WALL);
        POLISHED_CALCITE = blockItem(ADBlocks.POLISHED_CALCITE);
        POLISHED_CALCITE_STAIRS = blockItem(ADBlocks.POLISHED_CALCITE_STAIRS);
        POLISHED_CALCITE_SLAB = blockItem(ADBlocks.POLISHED_CALCITE_SLAB);
        POLISHED_CALCITE_WALL = blockItem(ADBlocks.POLISHED_CALCITE_WALL);
        DRIPSTONE_STAIRS = blockItem(ADBlocks.DRIPSTONE_STAIRS);
        DRIPSTONE_SLAB = blockItem(ADBlocks.DRIPSTONE_SLAB);
        DRIPSTONE_WALL = blockItem(ADBlocks.DRIPSTONE_WALL);
        CALCITE_STAIRS = blockItem(ADBlocks.CALCITE_STAIRS);
        CALCITE_SLAB = blockItem(ADBlocks.CALCITE_SLAB);
        CALCITE_WALL = blockItem(ADBlocks.CALCITE_WALL);
        BAMBOO_PLANTER_BOX = blockItem(ADBlocks.BAMBOO_PLANTER_BOX);
        STONE_WALL = blockItem(ADBlocks.STONE_WALL);
        QUARTZ_WALL = blockItem(ADBlocks.QUARTZ_WALL);
        SMOOTH_QUARTZ_WALL = blockItem(ADBlocks.SMOOTH_QUARTZ_WALL);
        GRASS_SLAB = blockItem(ADBlocks.GRASS_SLAB);
        PODZOL_SLAB = blockItem(ADBlocks.PODZOL_SLAB);
        MYCELIUM_SLAB = blockItem(ADBlocks.MYCELIUM_SLAB);
        DIRT_PATH_SLAB = blockItem(ADBlocks.DIRT_PATH_SLAB);
        DIRT_SLAB = blockItem(ADBlocks.DIRT_SLAB);
        COARSE_DIRT_SLAB = blockItem(ADBlocks.COARSE_DIRT_SLAB);
        ROOTED_DIRT_SLAB = blockItem(ADBlocks.ROOTED_DIRT_SLAB);
        WILD_GREEN_ONIONS = blockItem(ADBlocks.WILD_GREEN_ONIONS);
    }
}
