...
public final class ModFoods {
    ...
    public static final FoodProperties CARAMEL_APPLE = new FoodProperties.Builder().nutrition(7)
    ...
    public static final FoodProperties BLUEBERRIES = new FoodProperties.Builder().nutrition(2)
            .saturationModifier(0.1F).build();
    public static final FoodProperties JUICE = new FoodProperties.Builder().nutrition(4)
            .saturationModifier(0.4F).build();
    public static final FoodProperties NETHER_JUICE = new FoodProperties.Builder().nutrition(4)
